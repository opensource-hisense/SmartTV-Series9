...
CC                    := /mtkoss/gnuarm/hard_4.9.2-r116_armv7a-cros/x86_64/armv7a/bin/armv7a-cros-linux-gnueabi-gcc
CONFIG                ?= $(OS)-$(ARCH)-$(PROFILE)
BUILD                 ?= build/$(CONFIG)
LBIN                  ?= $(BUILD)/bin
PATH                  := $(BUILD)/../cast_server:.:$(LBIN):$(PATH)
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/appweb-linux-default-me-arm.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/appweb-linux-default-me-arm.h >/dev/null ; then\
		cp projects/appweb-linux-default-me-arm.h $(BUILD)/inc/me.h  ; \
	fi; true
