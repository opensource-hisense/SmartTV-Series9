...
struct wpa_driver_ops {
	...
	/**
	 * get_acs_rank_list - Get ACS (AutoChannelSelection Ranking list from driver
	 * @priv: Private driver interface data
	 * @buf: Buffer to be returned containing channel index information
	 * @buf_len: Length of the buffer given in the buf parameter
	 * Returns: Length of the output buffer
	 *
	 * This function is to get ACS channel ranking list result from driver
	 */
    int (*get_acs_rank_list)(void *priv, u8 *buf, int buf_len);
