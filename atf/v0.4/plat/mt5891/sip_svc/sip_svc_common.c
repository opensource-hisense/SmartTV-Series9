...
static void save_kernel_info(uint64_t pc, uint64_t r0, uint64_t r1, uint64_t r2)
{
    k_info.pc=pc;
    k_info.r0=r0;
    k_info.r1=r1;
			  ...
			  uint64_t flags)
{
    ...
    case MTK_SIP_KERNEL_TMP_AARCH32:
        ...
        SMC_RET0(handle);
        break;
    case MTK_SIP_KERNEL_L2_SHARING_AARCH32:
    case MTK_SIP_KERNEL_L2_SHARING_AARCH64:
        printf("config L2$ size\n");
        rc = switch_L2_size(x1, x2, x3);
        printf("config L2$ size done\n");
        break;
#if DEBUG
