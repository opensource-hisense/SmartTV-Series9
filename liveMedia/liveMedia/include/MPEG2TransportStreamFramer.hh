...
public:
  ...
  createNew(UsageEnvironment& env, FramedSource* inputSource, Boolean is_wfd = False);
  ...
  Boolean switchTransport(int port, int fTCP = 0);
protected:
...
private:
  ...
  int fTransport; //0:UDP, 1:TCP
  FramedSource* fUDPSource;
  Boolean is_for_wfd;
};
