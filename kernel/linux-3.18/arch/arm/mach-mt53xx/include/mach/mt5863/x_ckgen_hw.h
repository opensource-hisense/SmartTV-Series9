...
#ifndef __X_5863_CKGEN_HW_H__
#define __X_5863_CKGEN_HW_H__
...
typedef enum
{
    ...
    CAL_SRC_AD_FB_OUT,                  // 0x75 END HERE
...
#define CKGEN_PLLCALIB (IO_CKGEN_BASE + 0x0C0)
    #define FLD_CALI_FAIL Fld(1,31,AC_MSKB3)//[31:31] newadd
    #define FLD_SOFT_RST_CAL Fld(1,30,AC_MSKB3)//[30:30] newadd
    #define FLD_CAL_SEL Fld(3,16,AC_MSKB2)//[18:16]
	#define FLD_CAL_TRI Fld(1,15,AC_MSKB1)//[15:15] newadd
    #define FLD_DBGCK_SEL Fld(7,8,AC_MSKB1)//[14:8]
