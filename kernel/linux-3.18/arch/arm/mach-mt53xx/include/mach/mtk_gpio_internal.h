...
typedef struct {
    ...
    INT32 (*pfnStatus)(INT32, INT32*, INT32*, INT32*, INT32*);
...
EXTERN INT32 PDWNC_Native_GpioStatus(INT32 i4Gpio, INT32* pi4Pinmux, INT32* pi4Enable, INT32* pi4Output, INT32* pi4Input);
EXTERN INT32 PDWNC_Native_GPIO_Query(INT32 i4Gpio, INT32* pi4Intr, INT32* pi4Fall, INT32* pi4Rise);
EXTERN INT32 PDWNC_Native_GPIO_Stop(void);
