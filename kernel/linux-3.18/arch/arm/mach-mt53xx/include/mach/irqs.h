...
#elif defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
...
#define NR_IRQS         160
#elif defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
#define NR_IRQS         288
...
#elif defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5880) || defined(CONFIG_ARCH_MT5881) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)
#define VECTOR_PMU1         (4+VECTOR_MISC_BASE)
#define VECTOR_PMU0         (3+VECTOR_MISC_BASE)
#elif defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5863)
#define VECTOR_PMU1         (4+VECTOR_MISC_BASE)
...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
...
#if defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5863) 
...
#endif
#if !defined(CONFIG_ARCH_MT5399)  && !defined(CONFIG_ARCH_MT5886) && !defined(CONFIG_ARCH_MT5890) && !defined(CONFIG_ARCH_MT5891) && !defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865)
...
#if defined (CONFIG_ARCH_MT5399) || defined (CONFIG_ARCH_MT5890) || defined (CONFIG_ARCH_MT5891)  || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
...
#elif defined (CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) ||defined(CONFIG_ARCH_MT5863)
#define VECTOR_THERMAL0     (0+VECTOR_MISC3_BASE)
#define VECTOR_THERMAL1     (1+VECTOR_MISC3_BASE)
#define VECTOR_SC_TIMER     (2+VECTOR_MISC3_BASE)
#define VECTOR_HDMIRX_20    (3+VECTOR_MISC3_BASE)
...
extern void read_ahead_modules(void);
#endif /*IRQS_H*/
