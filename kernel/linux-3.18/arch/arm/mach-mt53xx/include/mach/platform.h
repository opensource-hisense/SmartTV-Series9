...
#ifndef IO_PHY
#ifdef CONFIG_MT53XX_EMI
#define IO_PHY             0x10000000    //(IO_PHY + IO_OFFSET)
#else
...
#define IO_SIZE             0x00300000    // 3MB, +1MB for SMI larbx regiser mapping.
#else
...
#define MUSB_FM_BASE1               (IO_PHY + 0x59f00)
#define MUSB_FM_BASE2               (IO_PHY + 0x53f00)
#define HPCPLL_PHY                  (IO_PHY + 0x60200)
...
#define PDWNC_PHY                   (IO_PHY + 0x28000)
#define CKGEN_PLLGP_PHY             (IO_PHY + 0x61000)

#ifdef CONFIG_CACHE_L2X0
#define L2C_BASE                (IO_PHY + 0x2000000)
#endif

#ifdef CONFIG_CPU_V7
#if defined(CONFIG_ARCH_MT5890)||defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)
#ifdef CONFIG_MT53XX_EMI
#define IO_CPU_PHY              (0x0c000000)
#define MPCORE_GIC_DIST_PHY    (IO_CPU_PHY + 0x10000)
#define MPCORE_GIC_CPU_PHY  (IO_CPU_PHY + 0x20000)

#define MPCORE_SCU_PHY     (IO_PHY + 0x2002000 + 0x0000)
#define MPCORE_GIT_PHY     (IO_PHY + 0x2002000 + 0x0600)
#else
#define IO_CPU_PHY				(IO_PHY + 0x2010000)
#define MPCORE_GIC_DIST_PHY    (IO_CPU_PHY + 0x1000)
#define MPCORE_GIC_CPU_PHY 	(IO_CPU_PHY + 0x2000)


#define MPCORE_SCU_PHY     (IO_PHY + 0x2002000 + 0x0000)
#define MPCORE_GIT_PHY     (IO_PHY + 0x2002000 + 0x0600)
#endif
#elif defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865)
#define IO_CPU_PHY				(IO_PHY + 0x1000000)
#define MPCORE_GIC_DIST_PHY    (IO_CPU_PHY + 0x1000)
#define MPCORE_GIC_CPU_PHY 	(IO_CPU_PHY + 0x2000)
...
#else
#define	IO_CPU_PHY		(IO_PHY + 0x2002000)
#define	MPCORE_SCU_PHY		(IO_CPU_PHY + 0x0000)
#define	MPCORE_GIC_CPU_PHY	(IO_CPU_PHY + 0x0100)
#define	MPCORE_GIT_PHY		(IO_CPU_PHY + 0x0600)
#define	MPCORE_GIC_DIST_PHY	(IO_CPU_PHY + 0x1000)
#endif
#endif

#ifdef CONFIG_MT53XX_EMI
#define SRAM_PHY			(0x04100000)
#define ROM_PHY				(0x06000000)
#else
#define SRAM_PHY            (0xFB000000)
#define ROM_PHY             (0xF4000000)
#endif
#define SRAM_VIRT			(0xFB000000)
#define ROM_VIRT			(0xF4000000)

#ifdef CONFIG_MT53XX_EMI
#define HOTPLUG_FW          (0x0410A000)    // Put FW at SRAM
#else
#define HOTPLUG_FW          (0x00000000)    // Put FW at DRAM start
#endif
//DBGPCSR
#define MT53XX_DEBUG_PA_CPU(x)  (IO_PHY + 0x1810000 + (x * 0x100000))
...
#elif defined(CONFIG_MACH_MT5891) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
#define REG_CKDIV			(0x0420)	// CKDIV
#define REG_GIC_CTL			(0x0424)	// GIC CONTROL
#define REG_CPU0_PWR_CTL	(0x0404)	// CPU0 POWER CONTROL
#define REG_CPU1_PWR_CTL	(0x0408)	// CPU1 POWER CONTROL
#define REG_CPU2_PWR_CTL	(0x040C)	// CPU2 POWER CONTROL
#define REG_CPU3_PWR_CTL	(0x0410)	// CPU3 POWER CONTROL
#define REG_STANDBY_STATUS	(0x0434)	// Standby status
    #define MEM_PD          (1U << 0)
    ...
    #define CLAMP           (1U << 10)
    #define SLPD_CLAMP      (1U << 11)
#elif defined(CONFIG_MACH_MT5882) || defined(CONFIG_ARCH_MT5865)
...
#define REG_STANDBY_STATUS	(0x0434)	// Standby status
#define REG_SMPC_PWR_CTL	(0x0438)	// SMPC power control
    #define PWR_ON          (1U << 0)
    #define PWR_ACK         (1U << 1)
    #define PWR_RST         (1U << 2)
#else
    #error "IC version is required"
#endif
...
#if defined(CONFIG_MACH_MT5890) || defined(CONFIG_MACH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)
...
//#endif
#if defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5865)
//ABIM register for cpu bootup/hotplug
// Main to Audio shared regsiters (0 ~ 5)
#define APROC_M2ASR30                            (0x8f8)
#define APROC_M2ASR31                            (0x8fc)

#define REG_CORE1_UP_MAGIC   APROC_M2ASR30
#define REG_CORE1_UP_ADDR    APROC_M2ASR31

#define REG_MCUCFG_INT_POL_CFG0 (0x620)
#else
#define REG_CORE1_UP_MAGIC   REG_RW_TIMER1_LLMT
#define REG_CORE1_UP_ADDR    REG_RW_TIMER1_HLMT
#endif
