...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)
...
#if defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) ||defined(CONFIG_ARCH_MT5863)
//#define XTAL_STRAP_MODE         (CKGEN_READ32(0) & 0x2000)
#define IS_XTAL_54MHZ()         0
#define IS_XTAL_60MHZ()         0
...
void mt53xx_timer_clear_intr(int irq)
{
    if (irq == VECTOR_T0) {
        __bim_writel(0x1, REG_BIM_INTR_CLEAR);
    } else if (irq == VECTOR_T1) {
        __bim_writel(0x2, REG_BIM_INTR_CLEAR);
    } else if (irq == VECTOR_T2) {
        __bim_writel(0x4, REG_BIM_INTR_CLEAR);
    }
}
EXPORT_SYMBOL(mt53xx_timer_clear_intr);
...
void __init mt53xx_timer_init(void)
{
    ...
    #if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891)||defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5886) ||defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5893)
    arch_mt53xx_arm_timer_init();
    #endif // CONFIG_ARCH_MT5890
    #endif
}

#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886) ||  defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5893)
...
#endif //  defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5893)
