...
#if defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5882)|| defined(CONFIG_ARCH_MT5886)||defined(CONFIG_ARCH_MT5863)||defined(CONFIG_ARCH_MT5893)	// MT5891/MT5885 PortD support fastconnect Ver2
