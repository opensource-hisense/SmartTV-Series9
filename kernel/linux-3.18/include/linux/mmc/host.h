...
/*Support MTK emmc sleep/awake hot boot*/
#define MMC_SUPPORT_SLEEP_HOT_BOOT    (0)
...
#define MSDC_TRY_SD		  (0x1 << 0)	/* SD spec initialization supported. */
#define MSDC_TRY_MMC      (0x1 << 1)    /* MMC spec initialization supported. */
#define MSDC_TRY_SDIO     (0x1 << 2)    /* SDIO spec initialization supported. */
  unsigned int        special_arg;
