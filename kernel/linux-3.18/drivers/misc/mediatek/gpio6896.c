...
#define u4IO32Read4B    		__ckgen_readl
#define vIO32Write4B(addr,val)  __ckgen_writel(val,addr)
...
#include <linux/soc/mediatek/mt5861/x_gpio_hw.h>
...
static INT32 _Native_CKGEN_GPIO_Intrq(INT32 i4GpioNum, INT32 *pfgSet)
{
    ...
    u4Val = (*pfgSet) ?
            (u4Val | (1U << (i4GpioNum & GPIO_INDEX_MASK))) :
            (u4Val & ~(1U << (i4GpioNum & GPIO_INDEX_MASK)));
#if defined(CONFIG_ARCH_MT5883)	|| defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
