 ...
 */
#define EN_PTP_OD (1)
#define SUPPORT_PTPOD_GPU (1)

extern void __iomem *ptpod_efuse;
#define EFUSE_TS1_ADDR		(ptpod_efuse + 0x0C8)
#define EFUSE_TS2_ADDR		(ptpod_efuse + 0x0CC)
#define EFUSE_TS3_ADDR		(ptpod_efuse + 0x0D0)
...
#define PTP_PTPCTRLSPARE0   (PTP_BASEADDR + 0x290)
