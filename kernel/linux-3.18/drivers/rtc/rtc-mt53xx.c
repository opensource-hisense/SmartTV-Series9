...
#define PDWNC_WDTCTL  (pRtctIoMap + 0x100)
#define PDWNC_PDSTAT1 (pRtctIoMap + 0x088)
#define PDWNC_PDSTAT0 (pRtctIoMap + 0x128)
...
static bool PDWNC_IsBootByWakeup(void)
{
	...
	#else
	return (((readl(PDWNC_WDTCTL)&0x0F000000) | readl(PDWNC_PDSTAT1) | readl(PDWNC_PDSTAT0)) != 0x0);
	#endif
}
