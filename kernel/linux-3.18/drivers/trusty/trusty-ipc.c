...
static struct mutex tipc_lock; /* protects access to this device */
...
#ifndef TRUSTY_FIX_DEV_NUM
#define TRUSTY_FIX_DEV_NUM
#endif

#define TRUSTY_FIX_MAJOR 200
#define TRUSTY_FIX_MINOR 0
...
static int __init tipc_init(void)
{
    ...
    mutex_init(&tipc_lock);

#ifdef TRUSTY_FIX_DEV_NUM
	dev = MKDEV(TRUSTY_FIX_MAJOR, TRUSTY_FIX_MINOR);
	ret = register_chrdev_region(dev, 1, KBUILD_MODNAME);
#else
