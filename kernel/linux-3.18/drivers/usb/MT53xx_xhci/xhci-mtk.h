...
#define MU3C_U2_PORT_MAX 6
#define MU3_DIS_RST_OFFSET 0xe4
...
struct mu3c_ippc_regs {
	__le32 ip_pw_ctr0;                             // R112_02 0xf00d8700
	__le32 ip_pw_ctr1;
	__le32 ip_pw_ctr2;
	__le32 ip_pw_ctr3;
	__le32 ip_pw_sts1;
	__le32 ip_pw_sts2;
	__le32 reserved0[3];
	__le32 ip_xhci_cap;                           // R112_02 0xf00d8720
	__le32 reserved1[2];
	__le64 u3_ctrl_p[MU3C_U3_PORT_MAX];
	__le64 u2_ctrl_p[MU3C_U2_PORT_MAX];
	__le32 reserved2;
	__le32 u2_phy_pll;                           // R112_02 0xf00d877C
...
struct xhci_hcd_mtk {
	...
	struct mu3c_ippc_regs __iomem *ippc_regs;        // R112_02 0xf00d8700 - 0xf00d87FF
#if defined(CONFIG_ARCH_MT5893)
	unsigned int portnum;
#endif
	void __iomem *usb_pdwnc_regs;
	int num_u2_ports;
	int num_u3_ports;
