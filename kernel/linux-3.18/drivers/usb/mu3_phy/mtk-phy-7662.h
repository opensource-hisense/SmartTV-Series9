...
#ifndef __MTK_PHY_7662_H
#define __MTK_PHY_7662_H

#define U2_SR_COEF_7662 28
...
//U3D_reg0
#define RG_SSUSB_RXDET_VTHSEL_H                   (0x3<<21) //22:21
#define RG_SSUSB_RXDET_VTHSEL_L                   (0x3<<19) //20:19
#define RG_SSUSB_RXDET_UPDN_SEL                   (0x1<<18) //18:18
#define RG_SSUSB_RXDET_UPDN_FORCE                 (0x1<<17) //17:17
#define RG_SSUSB_RXDET_RSEL                       (0x3<<15) //16:15
#define RG_SSUSB_TX_SR                            (0x7<<9) //11:9
#define RG_SSUSB_TX_R50_FON                       (0x1<<8) //8:8
#define RG_SSUSB_IDRV_CALIB                       (0x3f<<2) //7:2
#define RG_SSUSB_IDRV_ITAILOP_EN                  (0x1<<1) //1:1
#define RG_SSUSB_TX250MCK_INVB                    (0x1<<0) //0:0

//U3D_reg1
#define RG_SSUSB_RESERVE                          (0x3ff<<16) //25:16
#define RG_SSUSB_TXLBRX_EN                        (0x1<<13) //13:13
#define RG_SSUSB_RXLBTX_EN                        (0x1<<12) //12:12
#define RG_SSUSB_TX_EIDLE_CM                      (0xf<<8) //11:8
#define RG_SSUSB_CKMON_SEL                        (0xf<<4) //7:4
#define RG_SSUSB_TX_VLMON_SEL                     (0x3<<2) //3:2
#define RG_SSUSB_TX_VLMON_EN                      (0x1<<1) //1:1
#define RG_SSUSB_CKMON_EN                         (0x1<<0) //0:0

//U3D_reg2
#define RG_SSUSB_PLL_RESERVE                      (0x1ff<<23) //31:23
#define RG_SSUSB_PLL_AUTOK_PREDIV                 (0x3<<21) //22:21
#define RG_SSUSB_PLL_AUTOK_KF                     (0x3<<19) //20:19
#define RG_SSUSB_PLL_AUTOK_KS                     (0x3<<17) //18:17
#define RG_SSUSB_PLL_AUTOK_LOAD                   (0x1<<16) //16:16
#define RG_SSUSB_PLL_MONVC_EN                     (0x1<<10) //10:10
#define RG_SSUSB_PLL_MONCK_EN                     (0x1<<9) //9:9
#define RG_SSUSB_PLL_MONREF_EN                    (0x1<<8) //8:8
#define RG_SSUSB_PLL_V11_EN                       (0x1<<5) //5:5
#define RG_SSUSB_PLL_VOD_EN                       (0x1<<4) //4:4
#define RG_SSUSB_PLL_RST_DLY                      (0x3<<2) //3:2
#define RG_SSUSB_PLL_POSDIV                       (0x3<<0) //1:0

//U3D_reg3
#define RG_SSUSB_PLL_SSC_PRD                      (0xffff<<16) //31:16
#define RG_SSUSB_PLL_DDS_DMY                      (0xffff<<0) //15:0

//U3D_reg4
#define RG_SSUSB_CDR_MONMUX                       (0x1<<31) //31:31
#define RG_SSUSB_CDR_OSCDET_EN                    (0x1<<30) //30:30
#define RG_SSUSB_CDR_CPBIAS_SEL                   (0x1<<29) //29:29
#define RG_SSUSB_CDR_PD_DIV_SEL                   (0x1<<28) //28:28
#define RG_SSUSB_CDR_PD_DIV_BYPASS                (0x1<<27) //27:27
#define RG_SSUSB_PLL_DDS_FRAC_MUTE                (0x7<<20) //22:20
#define RG_SSUSB_PLL_DDS_OPTION_3T_EN             (0x1<<19) //19:19
#define RG_SSUSB_PLL_DDS_CALIB_SEL                (0x1<<18) //18:18
#define RG_SSUSB_PLL_DDS_CALIB_EN                 (0x1<<17) //17:17
#define RG_SSUSB_PLL_DDS_AUTO_DET_EN              (0x1<<16) //16:16
#define RG_SSUSB_PLL_PCW_NCPO_CHG                 (0x1<<15) //15:15
#define RG_SSUSB_PLL_DDS_C                        (0x7<<12) //14:12
#define RG_SSUSB_PLL_DDS_POSDIV                   (0x1<<11) //11:11
#define RG_SSUSB_PLL_DDS_MONEN                    (0x1<<8) //8:8
#define RG_SSUSB_PLL_DDS_VADJ                     (0x7<<4) //6:4
#define RG_SSUSB_PLL_DDS_LPF_EN                   (0x1<<3) //3:3
#define RG_SSUSB_PLL_CLK_PH_INV                   (0x1<<2) //2:2
#define RG_SSUSB_PLL_SSC_TRI_EN                   (0x1<<1) //1:1
#define RG_SSUSB_PLL_SSC_PHASE_INI                (0x1<<0) //0:0

//U3D_reg5
#define RG_SSUSB_RX_DAC_MUX                       (0x1f<<27) //31:27
#define RG_SSUSB_EQ_CURSEL                        (0x1<<26) //26:26
#define RG_SSUSB_RX_DAC_PWD                       (0x1<<25) //25:25
#define RG_SSUSB_RX_DAC_EN                        (0x1<<24) //24:24
#define RG_SSUSB_CDR_AUTOK_PREDIV                 (0x3<<18) //19:18
#define RG_SSUSB_CDR_AUTOK_KF                     (0x3<<16) //17:16
#define RG_SSUSB_CDR_AUTOK_KS                     (0x3<<14) //15:14
#define RG_SSUSB_CDR_REGOD                        (0x3<<12) //13:12
#define RG_SSUSB_CDR_MONEN_DIG                    (0x1<<11) //11:11
#define RG_SSUSB_CDR_MONEN                        (0x1<<10) //10:10
#define RG_SSUSB_CDR_AUTOK_LOAD                   (0x1<<8) //8:8
#define RG_SSUSB_CDR_EPEN                         (0x1<<7) //7:7
#define RG_SSUSB_CDR_PI_SLEW                      (0x3<<5) //6:5
#define RG_SSUSB_CDR_BYPASS                       (0x3<<3) //4:3
#define RG_SSUSB_CDR_RSTB_MANUAL                  (0x1<<2) //2:2
#define RG_SSUSB_CDR_RST_DLY                      (0x3<<0) //1:0

//U3D_reg6
#define RG_SSUSB_RX_PD_RST_PASS                   (0x1<<30) //30:30
#define RG_SSUSB_RX_PD_RST                        (0x1<<29) //29:29
#define RG_SSUSB_RX_P1_ENTRY_PASS                 (0x1<<28) //28:28
#define RG_SSUSB_RXAFE_DCMON_SEL                  (0xf<<24) //27:24
#define RG_SSUSB_LFPS_LPF                         (0x3<<21) //22:21
#define RG_SSUSB_LFPS_MON_EN                      (0x1<<20) //20:20
#define RG_PCIE_SIGDET_SLCOUT_SEL                 (0x1<<19) //19:19
#define RG_PCIE_SIGDET_CMPOUT_SEL                 (0x1<<18) //18:18
#define RG_PCIE_SIGDET_HF                         (0x3<<16) //17:16
#define RG_PCIE_SIGDET_LPF                        (0x3<<14) //15:14
#define RG_PCIE_SIGDET_VTH                        (0x3<<12) //13:12
#define RG_SSUSB_RX_SW_CTRL                       (0xf<<8) //11:8
#define RG_SSUSB_RX_50_TAR                        (0x3<<5) //6:5
#define RG_SSUSB_RX_50_LOWER                      (0x7<<2) //4:2
#define RG_SSUSB_RX_T2R_EN                        (0x1<<1) //1:1
#define RG_SSUSB_RX_R2T_EN                        (0x1<<0) //0:0

//U3D_reg7
#define RG_SSUSB_RX_DAC_MEAS_EN                   (0x1<<1) //1:1
#define RG_SSUSB_RX_PD_PICAL_SWAP                 (0x1<<0) //0:0

//U3D_reg8
#define RG_PCIE_RX_RESERVE                        (0xff<<16) //23:16
#define RG_SSUSB_RXAFE_RESERVE                    (0xff<<8) //15:8
#define RG_SSUSB_CDR_RESERVE                      (0xff<<0) //7:0

//U3D_reg9
#define RG_SSUSB_CKBG_RESERVE1                    (0x7f<<24) //30:24
#define RG_SSUSB_BG_MONEN                         (0x1<<23) //23:23
#define RG_SSUSB_VRT_25M_EN                       (0x1<<22) //22:22
#define RG_SSUSB_EXT_BIAS_SEL                     (0x1<<21) //21:21
#define RG_SSUSB_INT_BIAS_SEL                     (0x1<<20) //20:20
#define RG_SSUSB_VRT_FB_MONEN                     (0x1<<19) //19:19
#define RG_SSUSB_VRT_VREF_SEL                     (0x7<<16) //18:16
#define RG_SSUSB_REF_EN                           (0x1<<15) //15:15
#define RG_SSUSB_MPX_SEL                          (0xff<<7) //14:7
#define RG_SSUSB_MPX_OUT_SEL                      (0x3<<5) //6:5
#define RG_SSUSB_INTR_EN                          (0x1<<4) //4:4
#define RG_SSUSB_BG_DIV                           (0x3<<2) //3:2
#define RG_SSUSB_CHPEN                            (0x1<<1) //1:1
#define RG_SSUSB_BGR_EN                           (0x1<<0) //0:0

//U3D_regA
#define RG_SSUSB_XTAL_VTH                         (0x1f<<20) //24:20
#define RG_SSUSB_XTAL_AMPCTRL_EN                  (0x1<<19) //19:19
#define RG_SSUSB_XTAL_VREGVOD_EN                  (0x1<<18) //18:18
#define RG_SSUSB_XTAL_GM_PWD                      (0x7<<15) //17:15
#define RG_SSUSB_CKBG_RESERVE2                    (0xff<<7) //14:7
#define RG_PCIE_CLKDRV_AMP                        (0x7<<4) //6:4
#define RG_PCIE_CLKDRV_SLEW                       (0x3<<2) //3:2
#define RG_PCIE_CLKDRV_OFFSET                     (0x3<<0) //1:0

//U3D_regB
#define RG_SSUSB_SYSPLL_LF                        (0x1<<25) //25:25
#define RG_SSUSB_SYSPLL_PREDIV                    (0x3<<23) //24:23
#define RG_SSUSB_SYSPLL_FBSEL                     (0x3<<21) //22:21
#define RG_SSUSB_SYSPLL_RESERVE                   (0xf<<17) //20:17
#define RG_SSUSB_XTAL_HYS                         (0x1<<16) //16:16
#define RG_SSUSB_XTAL_RESERVE2_D1                 (0xff<<8) //15:8
#define RG_SSUSB_XTAL_RESERVE2_D0                 (0xff<<0) //7:0

//U3D_regC
#define RG_SSUSB_SYSPLL_PCW_NCPO_CHG              (0x1<<21) //21:21
#define RG_SSUSB_SYSPLL_RST_DLY                   (0x3<<19) //20:19
#define RG_SSUSB_SYSPLL_LVROD_EN                  (0x1<<18) //18:18
#define RG_SSUSB_SYSPLL_VOD_EN                    (0x1<<17) //17:17
#define RG_SSUSB_SYSPLL_MONREF_EN                 (0x1<<16) //16:16
#define RG_SSUSB_SYSPLL_MONVC_EN                  (0x1<<15) //15:15
#define RG_SSUSB_SYSPLL_MONCK_EN                  (0x1<<14) //14:14
#define RG_SSUSB_SYSPLL_DIVEN                     (0x7<<11) //13:11
#define RG_SSUSB_SYSPLL_BR                        (0x1<<10) //10:10
#define RG_SSUSB_SYSPLL_BP                        (0x1<<9) //9:9
#define RG_SSUSB_SYSPLL_POSDIV                    (0x3<<7) //8:7
#define RG_SSUSB_SYSPLL_FBDIV                     (0x7f<<0) //6:0

//U3D_regD
#define RG_SSUSB_SYSPLL_TOP_RESERVE               (0xffff<<0) //15:0

//U3D_regE
#define RG_SSUSB_SYSPLL_PCW_NCPO                  (0x7fffffff<<0) //30:0

//U3D_regF
#define RG_SSUSB_SYSPLL_DDS_OPTION_3T_EN          (0x1<<30) //30:30
#define RG_SSUSB_SYSPLL_DDS_CALIB_SEL             (0x1<<29) //29:29
#define RG_SSUSB_SYSPLL_DDS_CALIB_EN              (0x1<<28) //28:28
#define RG_SSUSB_SYSPLL_DDS_AUTO_DET_EN           (0x1<<27) //27:27
#define RG_SSUSB_SYSPLL_DDS_DMY                   (0xffff<<11) //26:11
#define RG_SSUSB_SYSPLL_DDS_SEL_EXT               (0x1<<10) //10:10
#define RG_SSUSB_SYSPLL_CLK_PH_INV                (0x1<<9) //9:9
#define RG_SSUSB_SYSPLL_DDS_LPF_EN                (0x1<<8) //8:8
#define RG_SSUSB_SYSPLL_DDS_MONEN                 (0x1<<7) //7:7
#define RG_SSUSB_SYSPLL_DDS_PI_PL_EN              (0x1<<6) //6:6
#define RG_SSUSB_SYSPLL_DDS_POSTDIV2              (0x1<<5) //5:5
#define RG_SSUSB_SYSPLL_DDS_PREDIV2               (0x1<<4) //4:4
#define RG_SSUSB_SYSPLL_DDS_HF_EN                 (0x1<<3) //3:3
#define RG_SSUSB_SYSPLL_DDS_PI_C                  (0x7<<0) //2:0

//U3D_reg10
#define RG_SSUSB_SYSPLL_DDS_FRAC_MUTE             (0x7<<0) //2:0

//U3D_reg11
#define RGS_SSUSB_SYSPLL_DDS_CALIB_C_STATE        (0x7<<12) //14:12
#define RGS_SSUSB_DDS_CALIB_C_STATE               (0x7<<9) //11:9
#define RGS_XTAL_AMP_OD                           (0x1<<8) //8:8
#define RGS_SSUSB_RX_DEBUG_RESERVE                (0xff<<0) //7:0

/* OFFSET */

//U3D_reg0
#define RG_SSUSB_RXDET_VTHSEL_H_OFST              (21)
#define RG_SSUSB_RXDET_VTHSEL_L_OFST              (19)
#define RG_SSUSB_RXDET_UPDN_SEL_OFST              (18)
#define RG_SSUSB_RXDET_UPDN_FORCE_OFST            (17)
#define RG_SSUSB_RXDET_RSEL_OFST                  (15)
#define RG_SSUSB_TX_SR_OFST                       (9)
#define RG_SSUSB_TX_R50_FON_OFST                  (8)
#define RG_SSUSB_IDRV_CALIB_OFST                  (2)
#define RG_SSUSB_IDRV_ITAILOP_EN_OFST             (1)
#define RG_SSUSB_TX250MCK_INVB_OFST               (0)

//U3D_reg1
#define RG_SSUSB_RESERVE_OFST                     (16)
#define RG_SSUSB_TXLBRX_EN_OFST                   (13)
#define RG_SSUSB_RXLBTX_EN_OFST                   (12)
#define RG_SSUSB_TX_EIDLE_CM_OFST                 (8)
#define RG_SSUSB_CKMON_SEL_OFST                   (4)
#define RG_SSUSB_TX_VLMON_SEL_OFST                (2)
#define RG_SSUSB_TX_VLMON_EN_OFST                 (1)
#define RG_SSUSB_CKMON_EN_OFST                    (0)

//U3D_reg2
#define RG_SSUSB_PLL_RESERVE_OFST                 (23)
#define RG_SSUSB_PLL_AUTOK_PREDIV_OFST            (21)
#define RG_SSUSB_PLL_AUTOK_KF_OFST                (19)
#define RG_SSUSB_PLL_AUTOK_KS_OFST                (17)
#define RG_SSUSB_PLL_AUTOK_LOAD_OFST              (16)
#define RG_SSUSB_PLL_MONVC_EN_OFST                (10)
#define RG_SSUSB_PLL_MONCK_EN_OFST                (9)
#define RG_SSUSB_PLL_MONREF_EN_OFST               (8)
#define RG_SSUSB_PLL_V11_EN_OFST                  (5)
#define RG_SSUSB_PLL_VOD_EN_OFST                  (4)
#define RG_SSUSB_PLL_RST_DLY_OFST                 (2)
#define RG_SSUSB_PLL_POSDIV_OFST                  (0)

//U3D_reg3
#define RG_SSUSB_PLL_SSC_PRD_OFST                 (16)
#define RG_SSUSB_PLL_DDS_DMY_OFST                 (0)

//U3D_reg4
#define RG_SSUSB_CDR_MONMUX_OFST                  (31)
#define RG_SSUSB_CDR_OSCDET_EN_OFST               (30)
#define RG_SSUSB_CDR_CPBIAS_SEL_OFST              (29)
#define RG_SSUSB_CDR_PD_DIV_SEL_OFST              (28)
#define RG_SSUSB_CDR_PD_DIV_BYPASS_OFST           (27)
#define RG_SSUSB_PLL_DDS_FRAC_MUTE_OFST           (20)
#define RG_SSUSB_PLL_DDS_OPTION_3T_EN_OFST        (19)
#define RG_SSUSB_PLL_DDS_CALIB_SEL_OFST           (18)
#define RG_SSUSB_PLL_DDS_CALIB_EN_OFST            (17)
#define RG_SSUSB_PLL_DDS_AUTO_DET_EN_OFST         (16)
#define RG_SSUSB_PLL_PCW_NCPO_CHG_OFST            (15)
#define RG_SSUSB_PLL_DDS_C_OFST                   (12)
#define RG_SSUSB_PLL_DDS_POSDIV_OFST              (11)
#define RG_SSUSB_PLL_DDS_MONEN_OFST               (8)
#define RG_SSUSB_PLL_DDS_VADJ_OFST                (4)
#define RG_SSUSB_PLL_DDS_LPF_EN_OFST              (3)
#define RG_SSUSB_PLL_CLK_PH_INV_OFST              (2)
#define RG_SSUSB_PLL_SSC_TRI_EN_OFST              (1)
#define RG_SSUSB_PLL_SSC_PHASE_INI_OFST           (0)

//U3D_reg5
#define RG_SSUSB_RX_DAC_MUX_OFST                  (27)
#define RG_SSUSB_EQ_CURSEL_OFST                   (26)
#define RG_SSUSB_RX_DAC_PWD_OFST                  (25)
#define RG_SSUSB_RX_DAC_EN_OFST                   (24)
#define RG_SSUSB_CDR_AUTOK_PREDIV_OFST            (18)
#define RG_SSUSB_CDR_AUTOK_KF_OFST                (16)
#define RG_SSUSB_CDR_AUTOK_KS_OFST                (14)
#define RG_SSUSB_CDR_REGOD_OFST                   (12)
#define RG_SSUSB_CDR_MONEN_DIG_OFST               (11)
#define RG_SSUSB_CDR_MONEN_OFST                   (10)
#define RG_SSUSB_CDR_AUTOK_LOAD_OFST              (8)
#define RG_SSUSB_CDR_EPEN_OFST                    (7)
#define RG_SSUSB_CDR_PI_SLEW_OFST                 (5)
#define RG_SSUSB_CDR_BYPASS_OFST                  (3)
#define RG_SSUSB_CDR_RSTB_MANUAL_OFST             (2)
#define RG_SSUSB_CDR_RST_DLY_OFST                 (0)

//U3D_reg6
#define RG_SSUSB_RX_PD_RST_PASS_OFST              (30)
#define RG_SSUSB_RX_PD_RST_OFST                   (29)
#define RG_SSUSB_RX_P1_ENTRY_PASS_OFST            (28)
#define RG_SSUSB_RXAFE_DCMON_SEL_OFST             (24)
#define RG_SSUSB_LFPS_LPF_OFST                    (21)
#define RG_SSUSB_LFPS_MON_EN_OFST                 (20)
#define RG_PCIE_SIGDET_SLCOUT_SEL_OFST            (19)
#define RG_PCIE_SIGDET_CMPOUT_SEL_OFST            (18)
#define RG_PCIE_SIGDET_HF_OFST                    (16)
#define RG_PCIE_SIGDET_LPF_OFST                   (14)
#define RG_PCIE_SIGDET_VTH_OFST                   (12)
#define RG_SSUSB_RX_SW_CTRL_OFST                  (8)
#define RG_SSUSB_RX_50_TAR_OFST                   (5)
#define RG_SSUSB_RX_50_LOWER_OFST                 (2)
#define RG_SSUSB_RX_T2R_EN_OFST                   (1)
#define RG_SSUSB_RX_R2T_EN_OFST                   (0)

//U3D_reg7
#define RG_SSUSB_RX_DAC_MEAS_EN_OFST              (1)
#define RG_SSUSB_RX_PD_PICAL_SWAP_OFST            (0)

//U3D_reg8
#define RG_PCIE_RX_RESERVE_OFST                   (16)
#define RG_SSUSB_RXAFE_RESERVE_OFST               (8)
#define RG_SSUSB_CDR_RESERVE_OFST                 (0)

//U3D_reg9
#define RG_SSUSB_CKBG_RESERVE1_OFST               (24)
#define RG_SSUSB_BG_MONEN_OFST                    (23)
#define RG_SSUSB_VRT_25M_EN_OFST                  (22)
#define RG_SSUSB_EXT_BIAS_SEL_OFST                (21)
#define RG_SSUSB_INT_BIAS_SEL_OFST                (20)
#define RG_SSUSB_VRT_FB_MONEN_OFST                (19)
#define RG_SSUSB_VRT_VREF_SEL_OFST                (16)
#define RG_SSUSB_REF_EN_OFST                      (15)
#define RG_SSUSB_MPX_SEL_OFST                     (7)
#define RG_SSUSB_MPX_OUT_SEL_OFST                 (5)
#define RG_SSUSB_INTR_EN_OFST                     (4)
#define RG_SSUSB_BG_DIV_OFST                      (2)
#define RG_SSUSB_CHPEN_OFST                       (1)
#define RG_SSUSB_BGR_EN_OFST                      (0)

//U3D_regA
#define RG_SSUSB_XTAL_VTH_OFST                    (20)
#define RG_SSUSB_XTAL_AMPCTRL_EN_OFST             (19)
#define RG_SSUSB_XTAL_VREGVOD_EN_OFST             (18)
#define RG_SSUSB_XTAL_GM_PWD_OFST                 (15)
#define RG_SSUSB_CKBG_RESERVE2_OFST               (7)
#define RG_PCIE_CLKDRV_AMP_OFST                   (4)
#define RG_PCIE_CLKDRV_SLEW_OFST                  (2)
#define RG_PCIE_CLKDRV_OFFSET_OFST                (0)

//U3D_regB
#define RG_SSUSB_SYSPLL_LF_OFST                   (25)
#define RG_SSUSB_SYSPLL_PREDIV_OFST               (23)
#define RG_SSUSB_SYSPLL_FBSEL_OFST                (21)
#define RG_SSUSB_SYSPLL_RESERVE_OFST              (17)
#define RG_SSUSB_XTAL_HYS_OFST                    (16)
#define RG_SSUSB_XTAL_RESERVE2_D1_OFST            (8)
#define RG_SSUSB_XTAL_RESERVE2_D0_OFST            (0)

//U3D_regC
#define RG_SSUSB_SYSPLL_PCW_NCPO_CHG_OFST         (21)
#define RG_SSUSB_SYSPLL_RST_DLY_OFST              (19)
#define RG_SSUSB_SYSPLL_LVROD_EN_OFST             (18)
#define RG_SSUSB_SYSPLL_VOD_EN_OFST               (17)
#define RG_SSUSB_SYSPLL_MONREF_EN_OFST            (16)
#define RG_SSUSB_SYSPLL_MONVC_EN_OFST             (15)
#define RG_SSUSB_SYSPLL_MONCK_EN_OFST             (14)
#define RG_SSUSB_SYSPLL_DIVEN_OFST                (11)
#define RG_SSUSB_SYSPLL_BR_OFST                   (10)
#define RG_SSUSB_SYSPLL_BP_OFST                   (9)
#define RG_SSUSB_SYSPLL_POSDIV_OFST               (7)
#define RG_SSUSB_SYSPLL_FBDIV_OFST                (0)

//U3D_regD
#define RG_SSUSB_SYSPLL_TOP_RESERVE_OFST          (0)

//U3D_regE
#define RG_SSUSB_SYSPLL_PCW_NCPO_OFST             (0)

//U3D_regF
#define RG_SSUSB_SYSPLL_DDS_OPTION_3T_EN_OFST     (30)
#define RG_SSUSB_SYSPLL_DDS_CALIB_SEL_OFST        (29)
#define RG_SSUSB_SYSPLL_DDS_CALIB_EN_OFST         (28)
#define RG_SSUSB_SYSPLL_DDS_AUTO_DET_EN_OFST      (27)
#define RG_SSUSB_SYSPLL_DDS_DMY_OFST              (11)
#define RG_SSUSB_SYSPLL_DDS_SEL_EXT_OFST          (10)
#define RG_SSUSB_SYSPLL_CLK_PH_INV_OFST           (9)
#define RG_SSUSB_SYSPLL_DDS_LPF_EN_OFST           (8)
#define RG_SSUSB_SYSPLL_DDS_MONEN_OFST            (7)
#define RG_SSUSB_SYSPLL_DDS_PI_PL_EN_OFST         (6)
#define RG_SSUSB_SYSPLL_DDS_POSTDIV2_OFST         (5)
#define RG_SSUSB_SYSPLL_DDS_PREDIV2_OFST          (4)
#define RG_SSUSB_SYSPLL_DDS_HF_EN_OFST            (3)
#define RG_SSUSB_SYSPLL_DDS_PI_C_OFST             (0)

//U3D_reg10
#define RG_SSUSB_SYSPLL_DDS_FRAC_MUTE_OFST        (0)

//U3D_reg11
#define RGS_SSUSB_SYSPLL_DDS_CALIB_C_STATE_OFST   (12)
#define RGS_SSUSB_DDS_CALIB_C_STATE_OFST          (9)
#define RGS_XTAL_AMP_OD_OFST                      (8)
...
//U3A_DA_REG0
#define reg0_FLD_RG_PCIE_SPEED_PE2D                            (0x1<<24)
#define reg0_FLD_RG_PCIE_SPEED_PE2H                            (0x1<<23)
#define reg0_FLD_RG_PCIE_SPEED_PE1D                            (0x1<<22)
#define reg0_FLD_RG_PCIE_SPEED_PE1H                            (0x1<<21)
#define reg0_FLD_RG_PCIE_SPEED_U3                              (0x1<<20)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE2D                     (0x3<<18)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE2H                     (0x3<<16)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE1D                     (0x3<<14)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE1H                     (0x3<<12)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_U3                       (0x3<<10)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE2D                   (0x3<<8)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE2H                   (0x3<<6)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE1D                   (0x3<<4)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE1H                   (0x3<<2)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_U3                     (0x3<<0)

//U3A_DA_REG1
#define reg1_FLD_RG_USB20_REFCK_SEL_PE2D                       (0x1<<30)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE2H                       (0x1<<29)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE1D                       (0x1<<28)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE1H                       (0x1<<27)
#define reg1_FLD_RG_USB20_REFCK_SEL_U3                         (0x1<<26)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE2D                       (0x1<<25)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE2H                       (0x1<<24)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE1D                       (0x1<<18)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE1H                       (0x1<<17)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_U3                         (0x1<<16)
#define reg1_FLD_RG_PCIE_MODE_PE2D                             (0x1<<8)
#define reg1_FLD_RG_PCIE_MODE_PE2H                             (0x1<<3)
#define reg1_FLD_RG_PCIE_MODE_PE1D                             (0x1<<2)
#define reg1_FLD_RG_PCIE_MODE_PE1H                             (0x1<<1)
#define reg1_FLD_RG_PCIE_MODE_U3                               (0x1<<0)

//U3A_DA_REG4
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE2D                       (0x7<<22)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE2H                       (0x7<<19)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE1D                       (0x7<<16)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE1H                       (0x7<<13)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_U3                         (0x7<<10)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE2D                          (0x3<<8)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE2H                          (0x3<<6)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE1D                          (0x3<<4)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE1H                          (0x3<<2)
#define reg4_FLD_RG_SSUSB_PLL_BC_U3                            (0x3<<0)

//U3A_DA_REG5
#define reg5_FLD_RG_SSUSB_PLL_BR_PE2D                          (0x7<<27)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE2H                          (0x7<<24)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE1D                          (0x7<<21)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE1H                          (0x7<<18)
#define reg5_FLD_RG_SSUSB_PLL_BR_U3                            (0x7<<15)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE2D                          (0x7<<12)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE2H                          (0x7<<9)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE1D                          (0x7<<6)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE1H                          (0x7<<3)
#define reg5_FLD_RG_SSUSB_PLL_IC_U3                            (0x7<<0)

//U3A_DA_REG6
#define reg6_FLD_RG_SSUSB_PLL_IR_PE2D                          (0xf<<24)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE2H                          (0xf<<16)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE1D                          (0xf<<8)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE1H                          (0xf<<4)
#define reg6_FLD_RG_SSUSB_PLL_IR_U3                            (0xf<<0)

//U3A_DA_REG7
#define reg7_FLD_RG_SSUSB_PLL_BP_PE2D                          (0xf<<24)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE2H                          (0xf<<16)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE1D                          (0xf<<8)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE1H                          (0xf<<4)
#define reg7_FLD_RG_SSUSB_PLL_BP_U3                            (0xf<<0)

//U3A_DA_REG8
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE2D                      (0x3<<24)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE2H                      (0x3<<16)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE1D                      (0x3<<8)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE1H                      (0x3<<2)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_U3                        (0x3<<0)

//U3A_DA_REG9
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE2H                      (0x7f<<24)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE1D                      (0x7f<<16)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE1H                      (0x7f<<8)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_U3                        (0x7f<<0)

//U3A_DA_REG10
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE2D                    (0x3<<26)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE2H                    (0x3<<24)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE1D                    (0x3<<18)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE1H                    (0x3<<16)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_U3                      (0x3<<8)
#define reg10_FLD_RG_SSUSB_PLL_FBKDIV_PE2D                    (0x7f<<0)

//U3A_DA_REG12
#define reg12_FLD_RG_SSUSB_PLL_PCW_NCPO_U3                     (0x7fffffff<<0)

//U3A_DA_REG13
#define reg13_FLD_RG_SSUSB_PLL_PCW_NCPO_PE1H                   (0x7fffffff<<0)

//U3A_DA_REG14
#define reg14_FLD_RG_SSUSB_PLL_PCW_NCPO_PE1D                   (0x7fffffff<<0)

//U3A_DA_REG15
#define reg15_FLD_RG_SSUSB_PLL_PCW_NCPO_PE2H                   (0x7fffffff<<0)

//U3A_DA_REG16
#define reg16_FLD_RG_SSUSB_PLL_PCW_NCPO_PE2D                   (0x7fffffff<<0)

//U3A_DA_REG19
#define reg19_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE1H                 (0xffff<<16)
#define reg19_FLD_RG_SSUSB_PLL_SSC_DELTA1_U3                   (0xffff<<0)

//U3A_DA_REG20
#define reg20_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE2H                 (0xffff<<16)
#define reg20_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE1D                 (0xffff<<0)

//U3A_DA_REG21
#define reg21_FLD_RG_SSUSB_PLL_SSC_DELTA_U3                    (0xffff<<16)
#define reg21_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE2D                 (0xffff<<0)

//U3A_DA_REG23
#define reg23_FLD_RG_SSUSB_PLL_SSC_DELTA_PE1D                  (0xffff<<16)
#define reg23_FLD_RG_SSUSB_PLL_SSC_DELTA_PE1H                  (0xffff<<0)

//U3A_DA_REG25
#define reg25_FLD_RG_SSUSB_PLL_SSC_DELTA_PE2D                  (0xffff<<16)
#define reg25_FLD_RG_SSUSB_PLL_SSC_DELTA_PE2H                  (0xffff<<0)

//U3A_DA_REG26
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE2D                   (0x1<<25)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE2H                   (0x1<<24)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE1D                   (0x1<<16)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE1H                   (0x1<<8)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_U3                     (0x1<<0)

//U3A_DA_REG28
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE2D                        (0x3<<24)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE2H                        (0x3<<16)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE1D                        (0x3<<10)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE1H                        (0x3<<8)
#define reg28_FLD_RG_SSUSB_CDR_BPA_U3                          (0x3<<0)

//U3A_DA_REG29
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE2D                        (0x7<<24)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE2H                        (0x7<<16)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE1D                        (0x7<<6)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE1H                        (0x7<<3)
#define reg29_FLD_RG_SSUSB_CDR_BPB_U3                          (0x7<<0)

//U3A_DA_REG30
#define reg30_FLD_RG_SSUSB_CDR_BR_PE2D                         (0x7<<24)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE2H                         (0x7<<16)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE1D                         (0x7<<6)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE1H                         (0x7<<3)
#define reg30_FLD_RG_SSUSB_CDR_BR_U3                           (0x7<<0)

//U3A_DA_REG31
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE2H                      (0x7f<<24)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE1D                      (0x7f<<16)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE1H                      (0x7f<<8)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_U3                        (0x7f<<0)

//U3A_DA_REG32
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE2D                      (0x3<<30)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE2H                      (0x3<<28)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE1D                      (0x3<<26)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE1H                      (0x3<<24)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_U3                        (0x3<<22)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE2D                  (0x3<<20)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE2H                  (0x3<<18)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE1D                  (0x3<<16)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE1H                  (0x3<<14)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_U3                    (0x3<<12)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE2D                      (0x1<<11)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE2H                      (0x1<<10)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE1D                      (0x1<<9)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE1H                      (0x1<<8)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_U3                        (0x1<<7)
#define reg32_FLD_RG_SSUSB_CDR_FBDIV_PE2D                      (0x7f<<0)

//U3A_DA_REG33
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE2D                       (0x1<<26)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE2H                       (0x1<<25)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE1D                       (0x1<<24)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE1H                       (0x1<<23)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_U3                         (0x1<<16)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE2D                      (0x3<<8)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE2H                      (0x3<<6)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE1D                      (0x3<<4)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE1H                      (0x3<<2)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_U3                        (0x3<<0)

/* OFFSET  */

//U3A_DA_REG0
#define reg0_FLD_RG_PCIE_SPEED_PE2D_OFST                       (24)
#define reg0_FLD_RG_PCIE_SPEED_PE2H_OFST                       (23)
#define reg0_FLD_RG_PCIE_SPEED_PE1D_OFST                       (22)
#define reg0_FLD_RG_PCIE_SPEED_PE1H_OFST                       (21)
#define reg0_FLD_RG_PCIE_SPEED_U3_OFST                         (20)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE2D_OFST                (18)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE2H_OFST                (16)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE1D_OFST                (14)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_PE1H_OFST                (12)
#define reg0_FLD_RG_SSUSB_XTAL_EXT_EN_U3_OFST                  (10)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE2D_OFST              (8)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE2H_OFST              (6)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE1D_OFST              (4)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_PE1H_OFST              (2)
#define reg0_FLD_RG_SSUSB_CDR_REFCK_SEL_U3_OFST                (0)

//U3A_DA_REG1
#define reg1_FLD_RG_USB20_REFCK_SEL_PE2D_OFST                  (30)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE2H_OFST                  (29)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE1D_OFST                  (28)
#define reg1_FLD_RG_USB20_REFCK_SEL_PE1H_OFST                  (27)
#define reg1_FLD_RG_USB20_REFCK_SEL_U3_OFST                    (26)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE2D_OFST                  (25)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE2H_OFST                  (24)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE1D_OFST                  (18)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_PE1H_OFST                  (17)
#define reg1_FLD_RG_PCIE_REFCK_DIV4_U3_OFST                    (16)
#define reg1_FLD_RG_PCIE_MODE_PE2D_OFST                        (8)
#define reg1_FLD_RG_PCIE_MODE_PE2H_OFST                        (3)
#define reg1_FLD_RG_PCIE_MODE_PE1D_OFST                        (2)
#define reg1_FLD_RG_PCIE_MODE_PE1H_OFST                        (1)
#define reg1_FLD_RG_PCIE_MODE_U3_OFST                          (0)

//U3A_DA_REG4
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE2D_OFST                  (22)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE2H_OFST                  (19)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE1D_OFST                  (16)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_PE1H_OFST                  (13)
#define reg4_FLD_RG_SSUSB_PLL_DIVEN_U3_OFST                    (10)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE2D_OFST                     (8)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE2H_OFST                     (6)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE1D_OFST                     (4)
#define reg4_FLD_RG_SSUSB_PLL_BC_PE1H_OFST                     (2)
#define reg4_FLD_RG_SSUSB_PLL_BC_U3_OFST                       (0)

//U3A_DA_REG5
#define reg5_FLD_RG_SSUSB_PLL_BR_PE2D_OFST                     (27)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE2H_OFST                     (24)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE1D_OFST                     (21)
#define reg5_FLD_RG_SSUSB_PLL_BR_PE1H_OFST                     (18)
#define reg5_FLD_RG_SSUSB_PLL_BR_U3_OFST                       (15)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE2D_OFST                     (12)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE2H_OFST                     (9)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE1D_OFST                     (6)
#define reg5_FLD_RG_SSUSB_PLL_IC_PE1H_OFST                     (3)
#define reg5_FLD_RG_SSUSB_PLL_IC_U3_OFST                       (0)

//U3A_DA_REG6
#define reg6_FLD_RG_SSUSB_PLL_IR_PE2D_OFST                     (24)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE2H_OFST                     (16)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE1D_OFST                     (8)
#define reg6_FLD_RG_SSUSB_PLL_IR_PE1H_OFST                     (4)
#define reg6_FLD_RG_SSUSB_PLL_IR_U3_OFST                       (0)

//U3A_DA_REG7
#define reg7_FLD_RG_SSUSB_PLL_BP_PE2D_OFST                     (24)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE2H_OFST                     (16)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE1D_OFST                     (8)
#define reg7_FLD_RG_SSUSB_PLL_BP_PE1H_OFST                     (4)
#define reg7_FLD_RG_SSUSB_PLL_BP_U3_OFST                       (0)

//U3A_DA_REG8
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE2D_OFST                 (24)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE2H_OFST                 (16)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE1D_OFST                 (8)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_PE1H_OFST                 (2)
#define reg8_FLD_RG_SSUSB_PLL_FBKSEL_U3_OFST                   (0)

//U3A_DA_REG9
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE2H_OFST                 (24)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE1D_OFST                 (16)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_PE1H_OFST                 (8)
#define reg9_FLD_RG_SSUSB_PLL_FBKDIV_U3_OFST                   (0)

//U3A_DA_REG10
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE2D_OFST                (26)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE2H_OFST                (24)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE1D_OFST                (18)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_PE1H_OFST                (16)
#define reg10_FLD_RG_SSUSB_PLL_PREDIV_U3_OFST                  (8)
#define reg10_FLD_RG_SSUSB_PLL_FBKDIV_PE2D_OFST                (0)

//U3A_DA_REG12
#define reg12_FLD_RG_SSUSB_PLL_PCW_NCPO_U3_OFST                (0)

//U3A_DA_REG13
#define reg13_FLD_RG_SSUSB_PLL_PCW_NCPO_PE1H_OFST              (0)

//U3A_DA_REG14
#define reg14_FLD_RG_SSUSB_PLL_PCW_NCPO_PE1D_OFST              (0)

//U3A_DA_REG15
#define reg15_FLD_RG_SSUSB_PLL_PCW_NCPO_PE2H_OFST              (0)

//U3A_DA_REG16
#define reg16_FLD_RG_SSUSB_PLL_PCW_NCPO_PE2D_OFST              (0)

//U3A_DA_REG19
#define reg19_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE1H_OFST            (16)
#define reg19_FLD_RG_SSUSB_PLL_SSC_DELTA1_U3_OFST              (0)

//U3A_DA_REG20
#define reg20_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE2H_OFST            (16)
#define reg20_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE1D_OFST            (0)

//U3A_DA_REG21
#define reg21_FLD_RG_SSUSB_PLL_SSC_DELTA_U3_OFST               (16)
#define reg21_FLD_RG_SSUSB_PLL_SSC_DELTA1_PE2D_OFST            (0)

//U3A_DA_REG23
#define reg23_FLD_RG_SSUSB_PLL_SSC_DELTA_PE1D_OFST             (16)
#define reg23_FLD_RG_SSUSB_PLL_SSC_DELTA_PE1H_OFST             (0)

//U3A_DA_REG25
#define reg25_FLD_RG_SSUSB_PLL_SSC_DELTA_PE2D_OFST             (16)
#define reg25_FLD_RG_SSUSB_PLL_SSC_DELTA_PE2H_OFST             (0)

//U3A_DA_REG26
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE2D_OFST              (25)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE2H_OFST              (24)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE1D_OFST              (16)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_PE1H_OFST              (8)
#define reg26_FLD_RG_SSUSB_PLL_REFCKDIV_U3_OFST                (0)

//U3A_DA_REG28
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE2D_OFST                   (24)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE2H_OFST                   (16)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE1D_OFST                   (10)
#define reg28_FLD_RG_SSUSB_CDR_BPA_PE1H_OFST                   (8)
#define reg28_FLD_RG_SSUSB_CDR_BPA_U3_OFST                     (0)

//U3A_DA_REG29
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE2D_OFST                   (24)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE2H_OFST                   (16)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE1D_OFST                   (6)
#define reg29_FLD_RG_SSUSB_CDR_BPB_PE1H_OFST                   (3)
#define reg29_FLD_RG_SSUSB_CDR_BPB_U3_OFST                     (0)

//U3A_DA_REG30
#define reg30_FLD_RG_SSUSB_CDR_BR_PE2D_OFST                    (24)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE2H_OFST                    (16)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE1D_OFST                    (6)
#define reg30_FLD_RG_SSUSB_CDR_BR_PE1H_OFST                    (3)
#define reg30_FLD_RG_SSUSB_CDR_BR_U3_OFST                      (0)


//U3A_DA_REG31
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE2H_OFST                 (24)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE1D_OFST                 (16)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_PE1H_OFST                 (8)
#define reg31_FLD_RG_SSUSB_CDR_FBDIV_U3_OFST                   (0)

//U3A_DA_REG32
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE2D_OFST                 (30)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE2H_OFST                 (28)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE1D_OFST                 (26)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_PE1H_OFST                 (24)
#define reg32_FLD_RG_SSUSB_EQ_RSTEP1_U3_OFST                   (22)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE2D_OFST             (20)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE2H_OFST             (18)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE1D_OFST             (16)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_PE1H_OFST             (14)
#define reg32_FLD_RG_SSUSB_LFPS_DEGLITCH_U3_OFST               (12)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE2D_OFST                 (11)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE2H_OFST                 (10)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE1D_OFST                 (9)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_PE1H_OFST                 (8)
#define reg32_FLD_RG_SSUSB_CDR_KVSEL_U3_OFST                   (7)
#define reg32_FLD_RG_SSUSB_CDR_FBDIV_PE2D_OFST                 (0)

//U3A_DA_REG33
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE2D_OFST                  (26)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE2H_OFST                  (25)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE1D_OFST                  (24)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_PE1H_OFST                  (23)
#define reg33_FLD_RG_SSUSB_RX_CMPWD_U3_OFST                    (16)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE2D_OFST                 (8)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE2H_OFST                 (6)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE1D_OFST                 (4)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_PE1H_OFST                 (2)
#define reg33_FLD_RG_SSUSB_EQ_RSTEP2_U3_OFST                   (0)
