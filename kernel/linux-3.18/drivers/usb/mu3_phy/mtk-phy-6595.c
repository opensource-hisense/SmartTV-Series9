...
#ifdef CONFIG_PROJECT_6595
#include "mtk-phy-6595.h"
...
PHY_INT32 u2_slew_rate_calibration(struct u3phy_info *info){
	...
	if(u4FmOut == 0){
		...
		// set reg = (1024/FM_OUT) * REF_CK * U2_SR_COEF_5399 / 1000 (round to the nearest digits)
		u4Tmp = (((1024 * REF_CK * U2_SR_COEF_5399) / u4FmOut) + 500) / 1000;
