...
PHY_INT32 phy_init_d60802(struct u3phy_info *info){
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u2phy_regs_d->usbphyacr5)
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u3phya_regs_d->reg5)
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u3phya_da_regs_d->reg21)
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u3phya_da_regs_d->reg32)
	...
	U3PhyWriteField32(((PHY_UINT32)&info->sifslv_chip_regs_d->syspll1)
		, (24), (0x1<<24), 0x1);
	#endif
 
	// PIPE drv = 2
	U3PhyWriteReg8(((PHY_UINT32)&info->sifslv_chip_regs_d->gpio_ctla+2), 0x10);
...
PHY_INT32 phy_change_pipe_phase_d60802(struct u3phy_info *info, PHY_INT32 phy_drv, PHY_INT32 pipe_phase){
	...
	temp = U3PhyReadReg8(((PHY_UINT32)&info->sifslv_chip_regs_d->gpio_ctla)+2);
	temp &= ~(0x3 << PHY_DRV_SHIFT);
	temp |= drv_reg_value;
	U3PhyWriteReg8(((PHY_UINT32)&info->sifslv_chip_regs_d->gpio_ctla)+2, temp);
	temp = U3PhyReadReg8(((PHY_UINT32)&info->sifslv_chip_regs_d->gpio_ctla)+3);
	temp &= ~((0x3 << PHY_PHASE_DRV_SHIFT) | (0x1f << PHY_PHASE_SHIFT));
	temp |= phase_reg_value;
	U3PhyWriteReg8(((PHY_UINT32)&info->sifslv_chip_regs_d->gpio_ctla)+3, temp);
...
{
	// Disable the test
	U3PhyWriteField32(((PHY_UINT32)&info->u3phyd_regs_d->eq_eye0)
...
#ifdef CONFIG_U3_PHY_GPIO_SUPPORT
	while(!U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon4)
  		, D60802_RGS_SSUSB_EQ_EYE_CNT_RDY_OFST, D60802_RGS_SSUSB_EQ_EYE_CNT_RDY));
#else
	while(!U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon5)
  		, D60802_RGS_SSUSB_EQ_EYE_CNT_RDY_OFST, D60802_RGS_SSUSB_EQ_EYE_CNT_RDY));
#endif
}
...
PHY_INT32 eyescan_init_d60802 (struct u3phy_info *info){
	//initial PHY setting
	U3PhyWriteField32(((PHY_UINT32)&info->u3phya_regs_d->reg9)
		, D60802_reg9_FLD_RG_SSUSB_CDR_EPEN_OFST, D60802_reg9_FLD_RG_SSUSB_CDR_EPEN, 1);
	U3PhyWriteField32(((PHY_UINT32)&info->u3phyd_regs_d->phyd_mix3)
...
PHY_INT32 phy_eyescan_d60802(struct u3phy_info *info, PHY_INT32 x_t1, PHY_INT32 y_t1, PHY_INT32 x_br, PHY_INT32 y_br, PHY_INT32 delta_x, PHY_INT32 delta_y
	...
	//force SIGDET to OFF
	#ifdef CONFIG_U3_PHY_GPIO_SUPPORT
	U3PhyWriteField32(((PHY_UINT32)&info->u3phyd_regs_d->phyd_reserved)
	...
	if (PI_cal_en){
		...
		_bPIResult = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon4)
		...
		_bPIResult = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon5)
			, D60802_RGS_SSUSB_EQ_PILPO_OFST, D60802_RGS_SSUSB_EQ_PILPO);				//read RGS_SSUSB_RX_PILPO
		#endif
	...
	// Set CYCLE
#ifdef CONFIG_U3_PHY_GPIO_SUPPORT
	U3PhyWriteField32(((PHY_UINT32)&info->u3phyd_regs_d->eq_eye2)
		, D60802_RG_SSUSB_EQ_EYE_CNT_OFST, D60802_RG_SSUSB_EQ_EYE_CNT, eye_cnt);		//RG_SSUSB_RX_EYE_CNT
#else
	U3PhyWriteField32(((PHY_UINT32)&info->u3phyd_regs_d->eq_eye3)
		,D60802_RG_SSUSB_EQ_EYE_CNT_OFST, D60802_RG_SSUSB_EQ_EYE_CNT, eye_cnt);			//RG_SSUSB_RX_EYE_CNT
#endif
	...
	while(isContinue){
		...
		if (fgValid){
			...
			for (bExtendCnt = 0; bExtendCnt < num_cnt; bExtendCnt++)
			{
				EyeScanHelper_RunTest(info);
#ifdef CONFIG_U3_PHY_GPIO_SUPPORT
				wErr0 = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon3)
					, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_0_OFST, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_0);
				wErr1 = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon3)
					, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_1_OFST, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_1);
#else
				wErr0 = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon3)
					, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_0_OFST, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_0);
				wErr1 = U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->phya_rx_mon4)
					, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_1_OFST, D60802_RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_1);
#endif
...
//					, bExtendCnt, _bXcurr, _bYcurr, cX, cY, pwErrCnt0[bExtendCnt][_bXcurr][_bYcurr], pwErrCnt1[bExtendCnt][_bXcurr][_bYcurr]);
	...
	printk(KERN_ERR "CurX [0x%x] CurY [0x%x]\n"
		, U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->eq_eye0), D60802_RG_SSUSB_EQ_EYE_XOFFSET_OFST, D60802_RG_SSUSB_EQ_EYE_XOFFSET)
		, U3PhyReadField32(((PHY_UINT32)&info->u3phyd_regs_d->eq_eye0), D60802_RG_SSUSB_EQ_EYE0_Y_OFST, D60802_RG_SSUSB_EQ_EYE0_Y));
...
PHY_INT32 u2_connect_d60802(struct u3phy_info *info){
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u2phy_regs_d->u2phydcr1)
...
PHY_INT32 u2_slew_rate_calibration_d60802(struct u3phy_info *info){
	...
	U3PhyWriteField32(((PHY_UINT32)&info->sifslv_fm_regs_d->fmmonr1)
		, D60802_RG_FRCK_EN_OFST, D60802_RG_FRCK_EN, 0x1);

	// => RG_CYCLECNT = 0x400
	// Setting cyclecnt = 0x400
	U3PhyWriteField32(((PHY_UINT32)&info->sifslv_fm_regs_d->fmcr0)
