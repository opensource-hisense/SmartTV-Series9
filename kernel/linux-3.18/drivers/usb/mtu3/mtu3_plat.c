...
#if 0 // CONFIG_MT53XX_XHCI_SUPPORT_DTS_REG_CLK
...
static int mtu3_probe(struct platform_device *pdev)
{
    ...
    {
    	printk("ADB U3 not enable\n");
		return ret;
	}
#ifdef CONFIG_USB_DELAY_RESUME_SUPPORT
		dev->power.is_delayresume = true;	  // USB3.0 user resume
#else
		dev->power.is_delayresume = true;	   // USB3.0 default not support user resume
#endif
...
#define DEV_PM_OPS &mtu3_pm_ops

#ifdef CONFIG_OF

static const struct of_device_id mtu3_of_match[] = {
	{.compatible = "mediatek,mt53xx-mtu3",},
	{},
};
