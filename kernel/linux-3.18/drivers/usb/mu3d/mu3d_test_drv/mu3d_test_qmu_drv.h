...
EXTERN void mu3d_hal_sw_erdy(DEV_UINT8 ep_num, DEV_UINT8 dir);
...
EXTERN void *bd_virt_to_phys(void *vaddr,USB_DIR dir,DEV_UINT32 num);
EXTERN void *gpd_phys_to_virt(void *vaddr,USB_DIR dir,DEV_UINT32 num);
EXTERN void dump_current_gpd(u32 DUMP_LEVEL, u32 Q_num, USB_DIR dir);
EXTERN void dev_otg(DEV_UINT8 mode);

EXTERN void *bd_phys_to_virt(void *vaddr,USB_DIR dir,DEV_UINT32 num);
