...
//#define ONLY4U3H_TEST   //sometimes U3D will be target device for U3H uni-test
...
typedef struct USB_SPD_DATA {
	DEV_UINT32 bus_len;
	DEV_UINT32 seed;
	DEV_UINT16 gpd_nr;
	DEV_UINT16 urb_nr;
	DEV_UINT8 spd2_padding;
}SPD_LOOPBACK_INFO;
...
typedef enum {
  ...
  CTRL_MODE_STATE,
  OTG_MODE_STATE,
  LOOPBACK_SPD_STATE,//[20]
  SPD_PROTOCOL_STATE,//lookback data contains protocol information
  SPD_PROTOCOL_TX,//lookback data contains protocol information
  SPD_PROTOCOL_RX,//lookback data contains protocol information
  UNIDIR_TRANSACTION=0x80
} USB3_TEST_CASE;
...
EXTERN DEV_UINT32 g_tx_intr_cnt, g_rx_intr_cnt;
EXTERN DEV_UINT16  g_hot_rst_cnt;
EXTERN DEV_UINT16  g_warm_rst_cnt;
EXTERN DEV_UINT16  g_rx_len_err_cnt;
EXTERN DEV_UINT32  g_rxq_done_cnt;
EXTERN DEV_UINT32  g_txq_done_cnt;
...
#ifdef SUPPORT_OTG
EXTERN DEV_UINT8 g_otg_exec;
EXTERN DEV_UINT8 g_otg_td_5_9;

EXTERN DEV_UINT8 g_otg_config;
EXTERN DEV_UINT8 g_otg_srp_reqd;
EXTERN DEV_UINT8 g_otg_hnp_reqd;
EXTERN DEV_UINT8 g_otg_hnp_reqd;
EXTERN DEV_UINT8 g_otg_b_hnp_enable;

EXTERN DEV_UINT8 g_otg_vbus_chg;
EXTERN DEV_UINT8 g_otg_reset;
EXTERN DEV_UINT8 g_otg_suspend;
EXTERN DEV_UINT8 g_otg_resume;
EXTERN DEV_UINT8 g_otg_connect;
EXTERN DEV_UINT8 g_otg_disconnect;
EXTERN DEV_UINT8 g_otg_chg_a_role_b;
EXTERN DEV_UINT8 g_otg_chg_b_role_b;
EXTERN DEV_UINT8 g_otg_attach_b_role;
#endif
...
EXTERN void dev_u1u2_en_ctrl(DEV_UINT8 type,DEV_UINT8 u_num,DEV_UINT8 opt,DEV_UINT8 cond,DEV_UINT8 u1_value, DEV_UINT8 u2_value);
...
EXTERN void mu3d_dev_lpm_config(LPM_INFO *lpm_info);
