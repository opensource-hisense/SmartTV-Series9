...
#define U3H_SSUSB_IP_PW_CTRL0                     (0x0000)
#define U3H_SSUSB_IP_PW_CTRL1                     (0x0004)
#define U3H_SSUSB_IP_PW_CTRL2                     (0x0008)
#define U3H_SSUSB_IP_PW_CTRL3                     (0x000C)
#define U3H_SSUSB_IP_PW_STS1                      (0x0010)
#define U3H_SSUSB_IP_PW_STS2                      (0x0014)
#define U3H_SSUSB_OTG_STS                         (0x0018)
#define U3H_SSUSB_OTG_STS_CLR                     (0x001C)
#define U3H_SSUSB_IP_MAC_CAP                      (0x0020)
#define U3H_SSUSB_IP_XHCI_CAP                     (0x0024)
#define U3H_SSUSB_IP_DEV_CAP                      (0x0028)
#define U3H_SSUSB_OTG_INT_EN                      (0x002C)
#define U3H_SSUSB_U3_CTRL_0P                      (0x0030)
#define U3H_SSUSB_U3_CTRL_1P                      (0x0038)
#define U3H_SSUSB_U3_CTRL_2P                      (0x0040)
#define U3H_SSUSB_U3_CTRL_3P                      (0x0048)	
#define U3H_SSUSB_U2_CTRL_0P                      (0x0050)
#define U3H_SSUSB_U2_CTRL_1P                      (0x0058)
#define U3H_SSUSB_U2_CTRL_2P                      (0x0060)
#define U3H_SSUSB_U2_CTRL_3P                      (0x0068)
#define U3H_SSUSB_U2_CTRL_4P                      (0x0070)
#define U3H_SSUSB_U2_CTRL_5P                      (0x0078)
#define U3H_SSUSB_U2_PHY_PLL                      (0x007C)
#define U3H_SSUSB_DMA_CTRL                        (0x0080)
#define U3H_SSUSB_MAC_CK_CTRL                     (0x0084)
#define U3H_SSUSB_CSR_CK_CTRL                     (0x0088)
#define U3H_SSUSB_REF_CK_CTRL                     (0x008C)
#define U3H_SSUSB_XHCI_CK_CTRL                    (0x0090)
#define U3H_SSUSB_XHCI_RST_CTRL                   (0x0094)
#define U3H_SSUSB_DEV_RST_CTRL                    (0x0098)
#define U3H_SSUSB_SYS_CK_CTRL                     (0x009C)
#define U3H_SSUSB_HW_ID                           (0x00A0)
#define U3H_SSUSB_HW_SUB_ID                       (0x00A4)
#define U3H_SSUSB_PRB_CTRL0                       (0x00B0)
#define U3H_SSUSB_PRB_CTRL1                       (0x00B4)
#define U3H_SSUSB_PRB_CTRL2                       (0x00B8)
#define U3H_SSUSB_PRB_CTRL3                       (0x00BC)
#define U3H_SSUSB_PRB_CTRL4                       (0x00C0)
#define U3H_SSUSB_PRB_CTRL5                       (0x00C4)
#define U3H_SSUSB_IP_SPARE0                       (0x00C8)
#define U3H_SSUSB_IP_SPARE1                       (0x00CC)
#define U3H_SSUSB_FPGA_I2C_OUT_0P                 (0x00D0)
#define U3H_SSUSB_FPGA_I2C_IN_0P                  (0x00D4)
#define U3H_SSUSB_FPGA_I2C_OUT_1P                 (0x00D8)
#define U3H_SSUSB_FPGA_I2C_IN_1P                  (0x00DC)
#define U3H_SSUSB_FPGA_I2C_OUT_2P                 (0x00E0)
#define U3H_SSUSB_FPGA_I2C_IN_2P                  (0x00E4)
#define U3H_SSUSB_FPGA_I2C_OUT_3P                 (0x00E8)
#define U3H_SSUSB_FPGA_I2C_IN_3P                  (0x00EC)
#define U3H_SSUSB_FPGA_I2C_OUT_4P                 (0x00F0)
#define U3H_SSUSB_FPGA_I2C_IN_4P                  (0x00F4)
#define U3H_SSUSB_IP_SLV_TMOUT                    (0x00F8)

/* SSUSB_SIFSLV_IPPC FIELD DEFINITION */

//U3H_SSUSB_IP_PW_CTRL0
...
#define SSUSB_OTG_STS			(0x18)

//#define SSUSB_OTG_STS_CLR		(SIFSLV_IPPC+0x1c)
#define SSUSB_OTG_STS_CLR		(0x1c)

//#define SSUSB_OTG_INT_EN		(SIFSLV_IPPC+0x2c)
#define SSUSB_OTG_INT_EN		(0x2c)
