...
#define U3H_XHCI_PORT_CTRL                        (0x0000)
#define U3H_POWER_MANAGEMENT                      (0x0004)
#define U3H_TIMING_TEST_MODE                      (0x0008)
#define U3H_DEVICE_CONTROL                        (0x000C)
#define U3H_POWER_UP_COUNTER                      (0x0010)
#define U3H_USB2_TEST_MODE                        (0x0014)
#define U3H_COMMON_USB_INTR_ENABLE                (0x0018)
#define U3H_COMMON_USB_INTR                       (0x001C)
#define U3H_USB_BUS_PERFORMANCE                   (0x0020)
#define U3H_LINK_RESET_INFO                       (0x0024)
#define U3H_LINK_RESET_INFO2                      (0x0028)
#define U3H_RESET_RESUME_TIME_VALUE               (0x0034)
#define U3H_UTMI_SIGNAL_SEL                       (0x0038)
#define U3H_USB20_FRAME_NUM                       (0x003C)
#define U3H_USB20_TIMING_PARAMETER                (0x0040)
#define U3H_USB20_LPM_PARAMETER                   (0x0044)
#define U3H_USB20_LPM_ENTRY_COUNT                 (0x0048)
#define U3H_USB20_MISC_CONTROL                    (0x004C)
#define U3H_USB20_LPM_TIMING_PARAM                (0x0050)
#define U3H_USB20_OPSTATE                         (0x0060)
...
//U3H_LINK_RESET_INFO2
#define WTRSTHS                                   (0xffff<<16) //31:16

//U3H_RESET_RESUME_TIME_VALUE
...
//U3H_USB20_MISC_CONTROL
#define LPM_U3_ACK_EN                             (0x1<<0) //0:0

//U3H_USB20_LPM_TIMING_PARAM
