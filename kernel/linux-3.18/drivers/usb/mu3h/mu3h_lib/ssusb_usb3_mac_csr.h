...
#define U3H_TS_CONFIG                             (0x0000)
#define U3H_PIPE                                  (0x0004)
#define U3H_LTSSM_PARAMETER                       (0x000C)
#define U3H_LTSSM_CTRL                            (0x0010)
#define U3H_LTSSM_INFO                            (0x0014)
#define U3H_USB3_CONFIG                           (0x001C)
#define U3H_USB3_U1_STATE_INFO                    (0x0050)
#define U3H_USB3_U2_STATE_INFO                    (0x0054)
#define U3H_UX_LFPS_TIMING_PARAMETER              (0x007C)
#define U3H_U1_LFPS_TIMING_PARAMETER_2            (0x0080)
#define U3H_U2_LB_LFPS_TIMING_PARAMETER_1         (0x0084)
#define U3H_U2_LB_LFPS_TIMING_PARAMETER_2         (0x0088)
#define U3H_U3_LFPS_TIMING_PARAMETER_1            (0x008C)
#define U3H_U3_LFPS_TIMING_PARAMETER_2            (0x0090)
#define U3H_PING_LFPS_TIMING_PARAMETER            (0x0094)
#define U3H_POLLING_LFPS_TIMING_PARAMETER_1       (0x0098)
#define U3H_POLLING_LFPS_TIMING_PARAMETER_2       (0x009C)
#define U3H_UX_EXIT_LFPS_TIMING_PARAMETER         (0x00A0)
#define U3H_P3_TIMING_PARAMETER                   (0x00A4)
#define U3H_WARM_RESET_TIMING_PARAMETER           (0x00A8)
#define U3H_UX_EXIT_TIMING_PARAMETER              (0x00AC)
#define U3H_REF_CK_PARAMETER                      (0x00B0)
#define U3H_LTSSM_TIMING_PARAMETER_1              (0x010C)
#define U3H_LTSSM_TIMING_PARAMETER_2              (0x0110)
#define U3H_LTSSM_TIMING_PARAMETER_3              (0x0114)
#define U3H_LTSSM_TIMING_PARAMETER_4              (0x0118)
#define U3H_LTSSM_TIMING_PARAMETER_5              (0x011C)
#define U3H_LTSSM_RXDETECT_CTRL                   (0x0120)
#define U3H_PIPE_RXDATA_ERR_INTR_ENABLE           (0x0128)
#define U3H_PIPE_RXDATA_ERR_INTR                  (0x012C)
#define U3H_PIPE_LATCH_SELECT                     (0x0130)
#define U3H_LINK_STATE_MACHINE                    (0x0134)
#define U3H_MAC_FAST_SIMULATION                   (0x0138)
#define U3H_LTSSM_INTR_ENABLE                     (0x013C)
#define U3H_LTSSM_INTR                            (0x0140)
#define U3H_SKP_CNT                               (0x0148)
