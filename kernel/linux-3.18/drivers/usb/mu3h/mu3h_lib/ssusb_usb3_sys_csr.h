...
#define U3H_LINK_HP_TIMER                         (0x0200)
#define U3H_LINK_CMD_TIMER                        (0x0204)
#define U3H_LINK_PM_TIMER                         (0x0208)
#define U3H_LINK_UX_INACT_TIMER                   (0x020C)
#define U3H_LINK_POWER_CONTROL                    (0x0210)
#define U3H_LINK_ERR_COUNT                        (0x0214)
#define U3H_LTSSM_TRANSITION                      (0x0218)
#define U3H_LINK_RETRY_CTRL                       (0x0220)
#define U3H_SYS_FAST_SIMULATIION                  (0x0224)
#define U3H_LINK_CAPABILITY_CTRL                  (0x0228)
#define U3H_LINK_DEBUG_INFO                       (0x022C)
#define U3H_USB3_U1_REJECT                        (0x0240)
#define U3H_USB3_U2_REJECT                        (0x0244)
#define U3H_DEV_NOTIF_0                           (0x0290)
#define U3H_DEV_NOTIF_1                           (0x0294)
#define U3H_VENDOR_DEV_TEST                       (0x0298)
#define U3H_VENDOR_DEF_DATA_LOW                   (0x029C)
#define U3H_VENDOR_DEF_DATA_HIGH                  (0x02A0)
#define U3H_HOST_SET_PORT_CTRL                    (0x02A4)
#define U3H_LINK_CAP_CONTROL                      (0x02AC)
#define U3H_PORT_CONF_TIMEOUT                     (0x02B0)
#define U3H_TIMING_PULSE_CTRL                     (0x02B4)
#define U3H_ISO_TIMESTAMP                         (0x02B8)
#define U3H_RECEIVE_PKT_INTR_EN                   (0x02C0)
#define U3H_RECEIVE_PKT_INTR                      (0x02C4)
#define U3H_CRC_ERR_INTR_EN                       (0x02C8)
#define U3H_CRC_ERR_INTR                          (0x02CC)
#define U3H_PORT_STATUS_INTR_EN                   (0x02D0)
#define U3H_PORT_STATUS_INTR                      (0x02D4)
#define U3H_RECOVERY_COUNT                        (0x02D8)
#define U3H_T2R_LOOPBACK_TEST                     (0x02DC)
...
//U3H_SYS_FAST_SIMULATIION
#define SYS_SPEED_MS_TO_US                        (0x1<<0) //0:0

//U3H_LINK_CAPABILITY_CTRL
