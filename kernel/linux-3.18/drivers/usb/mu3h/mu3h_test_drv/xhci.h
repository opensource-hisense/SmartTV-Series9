...
#define GET_MAX_EXIT(p) ((p) & MAX_EXIT)
#define BESL_MTK		(0xff)
#define GET_BESL(p) ((p) & BESL_MTK)
#define BESLD		(0xff<<8)
#define GET_BESLD(p) (((p) & BESLD)>>8)
...
/* slot ctx reserved */
#define PRE_PING_VALUE	(0x7FFF)
#define PRE_PING_MODE	(0x3 << 16)
#define GET_PRE_PING_VALUE(p) ((p) & PRE_PING_VALUE)
#define GET_PRE_PING_MODE(p)	(((p) & PRE_PING_MODE) >> 16)
...
int xhci_register_plat_device(void);
void xhci_unregister_plat_device(void);
