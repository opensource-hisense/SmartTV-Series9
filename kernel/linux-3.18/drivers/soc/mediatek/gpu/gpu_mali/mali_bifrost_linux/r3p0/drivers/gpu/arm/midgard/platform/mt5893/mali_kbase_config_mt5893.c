...
#ifdef CONFIG_GPU_MTCMOS_MT53xx
...
#endif //CONFIG_GPU_MTCMOS_MT53xx
...
#ifdef CONFIG_GPU_MTCMOS_MT53xx
    //pr_alert("start mfg_power_on! \n");
    mfg_power_on();
    //pr_alert("end mfg_power_on! \n");
#endif
...
#ifdef CONFIG_GPU_MTCMOS_MT53xx
    //pr_alert("start mfg_power_off! \n");
    mfg_power_off();
    //pr_alert("end mfg_power_off! \n");
#endif
