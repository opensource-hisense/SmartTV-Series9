...
#if 1/*def MTK_AUX_SUPPORT*/
#define FBIO_FBHWC_GET_VDP_DATA 0x480B
extern int mt_hwc_get_vdp_data(void* pvArg);
#endif
...
#if 1/*def MTK_AUX_SUPPORT*/
    if(cmd == FBIO_FBHWC_GET_VDP_DATA)
    {
        return  mt_hwc_get_vdp_data((void *)arg);
    }
#endif
