...
#include <linux/thermal.h>
	...
	#define REG_BOUNDING_EX (0xF0008664)
#else
	...
	#define MALI_PP3_MMU_IRQ  142//110
      #define REG_BOUNDING_EX (0xF00086C4)
#endif
#endif
...
#if 1//defined(CONFIG_ARCH_REALVIEW)
...
static struct resource mali_gpu_resources_m400_mp1[] = {
	MALI_GPU_RESOURCES_MALI400_MP1_PMU(0xF00C0000, MALI_GP_IRQ, MALI_GP_MMU_IRQ, MALI_PP0_IRQ, MALI_PP0_MMU_IRQ)
};

static struct resource mali_gpu_resources_m400_mp2[] = {
	MALI_GPU_RESOURCES_MALI400_MP2_PMU(0xF00C0000, MALI_GP_IRQ, MALI_GP_MMU_IRQ, MALI_PP0_IRQ, MALI_PP0_MMU_IRQ, MALI_PP1_IRQ, MALI_PP1_MMU_IRQ)
};
...
int mali_platform_device_register(void)
{
...
#else
	{
		/* Mali-450 MP2 r1p1 */
		#if defined(CONFIG_MALI450MP2)
		if((mali_read_phys(REG_BOUNDING_EX) & 0x1) == 0x1)
		{
		...
		else if((mali_read_phys(REG_BOUNDING_EX) & 0x700) == 0x400)
		{
