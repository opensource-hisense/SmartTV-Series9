...
static int kbase_common_device_init(struct kbase_device *kbdev)
{
	...
	INIT_LIST_HEAD(&kbdev->kctx_list);
        //check this minor number with dev4_2.txt and the device name in LINUX_MALI_DEVICE_NAME in mali_uku_linux.c
	kbdev->mdev.minor =  MALI_MISC_MINOR;   //MISC_DYNAMIC_MINOR
