...
#define PORT_MT53xx         5863
#endif


#if defined(CONFIG_ARCH_MT5865)
#define PORT_MT53xx         5865
#endif

#if defined(CONFIG_ARCH_MT5886)
#define PORT_MT53xx         5886
#endif
...
#ifdef ENABLE_UDMA
#if defined(CONFIG_ARCH_MT5893)
#define LOG_REGISTER  			0x100321b4
#else
...
#if defined(CONFIG_ARCH_MT5893)
#define DEBUG_C0D0              0X100321B0        //LOW 16 BIT
#define DEBUG_C140              0X100321AC        //LOW 16 BIT
#else
