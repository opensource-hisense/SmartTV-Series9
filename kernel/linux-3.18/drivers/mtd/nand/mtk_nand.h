...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5883)|| defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886)|| defined(CONFIG_ARCH_MT5863)
#define CC_NAND_60BIT_NFI       (1)
#else
#define CC_NAND_60BIT_NFI       (0)
#endif

#if defined(CC_MT5880) || defined(CC_MT5860) || defined(CONFIG_ARCH_MT5880) || defined(CONFIG_ARCH_MT5881) || defined(CONFIG_ARCH_MT5860) || defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882)|| defined(CONFIG_ARCH_MT5883) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886)|| defined(CONFIG_ARCH_MT5863)
...
#define NAND_DRAM_BASE                              ((UINT32)0x00000000)
#else
...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886)|| defined(CONFIG_ARCH_MT5863)
    #define NAND_NFI_ADDRCNTR_SEC_CNTR(x)               ((((UINT32) x ) & 0x1F) << 11)
#elif defined(CONFIG_ARCH_MT5883)
	#define NAND_NFI_ADDRCNTR_SEC_CNTR(x)				((((UINT32) x ) & 0x1F) << 13)
#else
...
#if CC_NAND_60BIT_NFI
#define NAND_NFI_MLC_CFG                            0x00BFC
#else
#define NAND_NFI_MLC_CFG                            0x00FFC
#endif
