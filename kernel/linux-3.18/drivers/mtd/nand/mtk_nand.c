...
#include <mach/irqs.h>
#endif
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5883)|| defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)|| defined(CONFIG_ARCH_MT5863)
...
#if !defined(CONFIG_ARCH_MT5398) && !defined(CONFIG_ARCH_MT5399) && !defined(CONFIG_ARCH_MT5880) && !defined(CONFIG_ARCH_MT5860) && !defined(CONFIG_ARCH_MT5890)&& !defined(CONFIG_ARCH_MT5861)&& !defined(CONFIG_ARCH_MT5882)&& !defined(CONFIG_ARCH_MT5883) && !defined(CONFIG_ARCH_MT5891) && !defined(CONFIG_ARCH_MT5893) && !defined(CONFIG_ARCH_MT5886) && !defined(CONFIG_ARCH_MT5863)
...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886)|| defined(CONFIG_ARCH_MT5863)
        u4Val &= 0xF800;
    ...
    for(i = 0; i < u4DevCount; i++)
    {
        ...
        if((u4ID & prDev->u4IDMask) == (prDev->u4IDVal & prDev->u4IDMask))
        {
            ...
            else if(0x9590DC01 == u4ID)
            {
             ...
             else if(0x9590DCC2 == u4ID)
            {
                if(0x00000056 == (0x000000FF & NANDHW_ReadIDEx(&u4ID)))
                {
                		strcpy( _prFlashDev->acName,"MX30LF4G18AC");
                    printk(KERN_INFO "NAND flash ExID: 0x%X\n", 0x00000056);
                }
            }
             else if(0x9590DAC2 == u4ID)
            {
                if(0x000006 == (0x000000FF & NANDHW_ReadIDEx(&u4ID)))
                {
                		strcpy( _prFlashDev->acName,"MX30LF2G18AC");
                		_prFlashDev->u4OOBSize = 16;
                    printk(KERN_INFO "NAND flash ExID: 0x%X\n", 0x00000006);
                }
            }
...
void MTK_NAND_Suspend(void)
{
	_u4Suspend[0]= NAND_READ32(NAND_NFI_ACCCON1);
	_u4Suspend[1]= NAND_READ32(NAND_NFI_ACCCON2);
	
	printk(KERN_ERR "ACCCON1 =0x%08X, ACCCON2=0x%08X ",NAND_READ32(NAND_NFI_ACCCON1),NAND_READ32(NAND_NFI_ACCCON2));
	printk(KERN_ERR "_NANDHW_Suspend");
...
static void _NANDHW_NFIECC_CheckEccDone(void)
{
    ...
    for (u4SectIdx = 0; u4SectIdx < _u4SectorNum; u4SectIdx++)
    {
        ...
        _NANDHW_WaitEccDone(_u4SectorNum - 1);
#endif
}
...
static void _NANDHW_NFI_SetRdDma(UINT32 *pu4DataAddr)
{
    ...
    NAND_WRITE32(NAND_NFIECC_FDMADDR, (UINT32)(NAND_REG_BASE + NAND_NFI_FDM0L));
}
...
void MTK_NAND_Resum(void)
{
		...
		_NANDHW_NFI_SetPageFmt();
		NAND_WRITE32(NAND_NFI_ACCCON1, _u4Suspend[0]);
    NAND_WRITE32(NAND_NFI_ACCCON2, _u4Suspend[1]);
...
void _NANDHW_CLKONOFF(BOOL fgOn)
{
    if(fgOn) //turn on clk
    {
        ...
        #elif defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882)|| defined(CONFIG_ARCH_MT5883) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863)
...
#if !defined(CONFIG_ARCH_MT5399) && !defined(CONFIG_ARCH_MT5398) && !defined(CONFIG_ARCH_MT5880) && !defined(CONFIG_ARCH_MT5860)&& !defined(CONFIG_ARCH_MT5890)&& !defined(CONFIG_ARCH_MT5861)&& !defined(CONFIG_ARCH_MT5882) && !defined(CONFIG_ARCH_MT5883)&& !defined(CONFIG_ARCH_MT5891) && !defined(CONFIG_ARCH_MT5893) && !defined(CONFIG_ARCH_MT5886)&& !defined(CONFIG_ARCH_MT5863)
...
static INT32 __init mtk_nand_init(void)
{
	...
	if (!np1) {
		pr_err("%s: Nand node not found,please add in MT5890_hmp.dts\n", __FUNCTION__);
	}
