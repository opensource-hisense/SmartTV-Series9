...
#define STAR_ETH_PDREG_SOFT_RST(base)		(base + 0x308)
	#define ETH_MAC_RST                     (1 << 0)
	#define ETH_PHY_RST                     (1 << 1)
