...
u64 notrace arch_timer_read_pcounter(void)
{
...
void __init arch_mt53xx_arm_timer_init(void)
{
    arch_timer_ppi[PHYS_SECURE_PPI] = 29;
    arch_timer_ppi[PHYS_NONSECURE_PPI] = 30;
    arch_timer_ppi[VIRT_PPI] = 27;
    arch_timer_ppi[HYP_PPI] = 26;
