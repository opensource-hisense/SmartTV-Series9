...
static const EMMC_FLASH_DEV_T _arEMMC_DevInfo_Lemurplus[] =
{
  ...
  {"UNKNOWN",               0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000000A, 0x00000102, 0x0000030D},
  {"KLM4G1FEPD-B001",       0x00344650, 0x44335202, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x00000000, 0x0E310200, 0x010D000D},
  {"THGBMBG5D1KBAIL",       0x00303034, 0x47453000, 0x00000000, 0x00000000, 0x00001F00, 0x001F0010, 0x00000102, 0x0000130F, 0x14410014, 0x000B000B},
  ...
  {"THGBMDG5D1LBAIL",       0x00303034, 0x47363002, 0x00000000, 0x00000000, 0x01800A00, 0x00030003, 0x00000102, 0x0000130F, 0x14310714, 0x01080008},
  {"THGBMDG5D1LBAIT",       0x00303034, 0x47363002, 0x00000000, 0x00000000, 0x01800A00, 0x00030003, 0x00000102, 0x0000130F, 0x14310714, 0x01080008},
  {"MTFC8GACAAAM-1M WT",    0x4E503158, 0x58585812, 0x00000000, 0x00000000, 0x1861001c, 0x01000100, 0x00000002, 0x03000d0d, 0x00200601, 0x01010004},
  {"SDIN9D2-8G",            0x00445332, 0x30303801, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000102, 0x00000000, 0x0910090B, 0x00070005},
  {"H26M41204HRP",          0x4A483847, 0x346192A1, 0x00000000, 0x00000000, 0x01000A00, 0x00017017, 0x00000102, 0x00000000, 0x00310500, 0x0100000B},
};
#endif
...
static void msdc_sample_delay(struct mmc_host *mmc)
{
...
#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5865) || \
	...
	defined(CONFIG_ARCH_MT5893)
		...
		ERR_MSG("[Kernel] DDR50 param 0x%x, 0x%x \n",ett[emmcidx].DDR52Sample,ett[emmcidx].DDR52Delay);
        #if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5865) || \
        	defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5882) || \
			defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863) || \
			defined(CONFIG_ARCH_MT5893)
			{
				...
				/*++++++++++++++++++++++cmd part+++++++++++++++++++*/
				sdr_set_field(MSDC_PATCH_BIT1, MSDC_PB1_CMD_RSP_TA_CNTR, 1);
				sdr_set_field(MSDC_PAD_TUNE0, MSDC_PAD_TUNE0_CMDRRDLY, (u4Sample & 0xff000000) >> 24);
				sdr_set_field(MSDC_IOCON, MSDC_IOCON_RSPL, (u4Sample & 0x000f0000) >> 16);
				sdr_set_field(MSDC_PAD_TUNE0, MSDC_PAD_TUNE0_CMDRDLY, (u4Sample & 0x0000ff00) >> 8);

				/*++++++++++++++++++++++write part+++++++++++++++++++*/
				sdr_set_field(MSDC_PATCH_BIT1, MSDC_PB1_WRDAT_CRCS_TA_CNTR, 1);
				sdr_set_field(MSDC_PAD_TUNE0, MSDC_PAD_TUNE0_DATWRDLY, u4Sample & 0x000000ff);
				sdr_set_field(MSDC_IOCON, MSDC_IOCON_W_D_SMPL, (u4Delay & 0xff000000) >> 24);
				sdr_set_field(MSDC_DAT_RDDLY0, MSDC_DAT_RDDLY0_D0, (u4Delay & 0x00ff0000) >> 16);

				/*++++++++++++++++++++++read part+++++++++++++++++++*/
				sdr_set_field(MSDC_IOCON, MSDC_IOCON_R_D_SMPL, (u4Delay & 0x00ff00) >> 8);
				sdr_set_field(MSDC_PAD_TUNE0, MSDC_PAD_TUNE0_DATRRDLY, u4Delay & 0x000000ff);
			}
		#else
			{
				sdr_set_bits(MSDC_PAD_TUNE, _arEMMC_DevInfo1[emmcidx].DDR52Delay);
			}
		#endif
...
static void msdc_sample_edge(struct mmc_host *mmc)
{
	...
	if (mmc->ios.timing == MMC_TIMING_LEGACY) {
		...
		sdr_set_bits(MSDC_IOCON, ett[emmcidx].DS26Sample & 0xFFFFFF);
	}
	else if (mmc->ios.timing == MMC_TIMING_MMC_HS) {
#if defined(CONFIG_ARCH_MT5399)
		sdr_clr_bits(MSDC_IOCON, 0xFFFFFF);
		sdr_set_bits(MSDC_IOCON, ett[emmcidx].HS52Sample & 0xFFFFFF);
#endif
	} else if (mmc->ios.timing == MMC_TIMING_UHS_DDR50) {
		sdr_clr_bits(MSDC_IOCON, 0xFFFFFF);
