...
#######################################--Begin RPC--########################################
echo "start clean mtk rpcipc"
sh clean_mtk_rpcipc.sh
echo "start clean rpcipc btservice"
sh clean_rpcipc_bt_service.sh
echo "start clean mw rpc test"
sh clean_mw_rpc_test.sh
echo "start clean btservice"
sh clean_btservice.sh
#######################################--End RPC--########################################
