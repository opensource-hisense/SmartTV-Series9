...
cp ${Bluetooth_Prebuilts_Dir}/lib/libipcrpc.so ${Build_Platform_Libs_Path}
cp ${Bluetooth_Prebuilts_Dir}/lib/libmtk_bt_*.so ${Build_Platform_Libs_Path}
cp ${Bluetooth_Prebuilts_Dir}/conf/*.conf ${Build_Platform_Libs_Path}/../config/
cp ${Bluetooth_Mw_Dir}/conf/*.conf ${Build_Platform_Libs_Path}/../config/
cp ${Bluetooth_Prebuilts_Dir}/bin/btmw-test ${Build_Platform_Bins_Path}
cp ${Bluetooth_Prebuilts_Dir}/bin/btservice ${Build_Platform_Bins_Path}
cp ${Bluetooth_Prebuilts_Dir}/bin/btmw-rpc-test ${Build_Platform_Bins_Path}
