...
typedef enum {
  ...
  VENDOR_SET_FW_ASSERT        = BT_VND_OP_SET_FW_ASSERT,
  VENDOR_SET_PSM_CONTROL      = BT_VND_OP_SET_PSM_CONTRL,
#endif
} vendor_opcode_t;
...
#if defined(MTK_VENDOR_OPCODE) && (MTK_VENDOR_OPCODE == TRUE)
  VENDOR_HANDLE_VENDOR_MESSAGE= BT_VND_OP_HANDLE_VENDOR_MESSAGE,
#endif
  VENDOR_LAST_OP
