...
#define BTTRC_ID_STK_B3DS                  54       /* B3DS_INCLUDED */
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#ifndef B3DS_INITIAL_TRACE_LEVEL
#define B3DS_INITIAL_TRACE_LEVEL            BT_TRACE_LEVEL_WARNING  /* B3DS_INCLUDED */
#endif
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
/* define traces for B3DS */ /* B3DS_INCLUDED */
#define B3DS_TRACE_ERROR(...)                     {if (b3ds_cb.trace_level >= BT_TRACE_LEVEL_ERROR) BT_TRACE(TRACE_LAYER_B3DS, TRACE_TYPE_ERROR, ##__VA_ARGS__);}
#define B3DS_TRACE_WARNING(...)                   {if (b3ds_cb.trace_level >= BT_TRACE_LEVEL_WARNING) BT_TRACE(TRACE_LAYER_B3DS, TRACE_TYPE_WARNING, ##__VA_ARGS__);}
#define B3DS_TRACE_API(...)                       {if (b3ds_cb.trace_level >= BT_TRACE_LEVEL_API) BT_TRACE(TRACE_LAYER_B3DS, TRACE_TYPE_API, ##__VA_ARGS__);}
#define B3DS_TRACE_EVENT(...)                     {if (b3ds_cb.trace_level >= BT_TRACE_LEVEL_EVENT) BT_TRACE(TRACE_LAYER_B3DS, TRACE_TYPE_EVENT, ##__VA_ARGS__);}
#define B3DS_TRACE_DEBUG(...)                     {if (b3ds_cb.trace_level >= BT_TRACE_LEVEL_DEBUG) BT_TRACE(TRACE_LAYER_B3DS, TRACE_TYPE_DEBUG, ##__VA_ARGS__);}
#endif
