...
extern BOOLEAN btsnd_enh_hcic_setup_esco_conn (UINT16 handle,
                                           ...
                                           UINT8 outputTransportUnitSize, UINT16 maxLatency,
                                           UINT16 packet_types, UINT8 retrans_effort);

#define HCIC_PARAM_SIZE_ENH_SETUP_ESCO      59


/* command HCI_Enhanced_Accept_Synchronous_Connection */
extern BOOLEAN btsnd_enh_hcic_accept_esco_conn (BD_ADDR bd_addr,
                                           UINT32 tx_bw, UINT32 rx_bw, BtAudioCodingFormat txCoding,
                                           BtAudioCodingFormat rxCoding, UINT16 txCodecFrameSize,
                                           UINT16 rxCodecFrameSize, UINT32 inputBandwith,
                                           UINT32 outputBandwith, BtAudioCodingFormat inputCoding,
...
#define HCIC_PARAM_SIZE_ENH_ACCEPT_ESCO      63
#endif
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
extern BOOLEAN btsnd_hcic_set_psm_state (BOOLEAN state);
#endif
...
extern BOOLEAN btsnd_hcic_send_hci(UINT8 *buff, UINT8 len);
#endif
...
extern BOOLEAN btsnd_hcic_write_synchronization_train_parameter(UINT16 interval_min, UINT16 interval_max,
    UINT32 synchronization_train_to, UINT8 service_data);
#define HCIC_PARAM_SIZE_WRITE_SYNC_TRAIN_PARAM      9

extern BOOLEAN btsnd_hcic_start_synchronization_train(void);
#define HCIC_PARAM_SIZE_START_SYNC_TRAIN            0

extern BOOLEAN btsnd_hcic_set_triggered_clock_capture(UINT16 handle, UINT8 enable,
    UINT8 which_clock, UINT8 lpo_allowed, UINT8 num_clock_captures_to_filter);
#define HCIC_PARAM_SIZE_SET_TRIGGERED_CLOCK_CAPTURE    6

extern BOOLEAN btsnd_hcic_set_connectionless_slave_broadcast(UINT8 enable, UINT8 lt_addr,
...
extern BOOLEAN btsnd_hcic_set_connectionless_slave_broadcast_data(UINT8 lt_addr, UINT8 fragment, UINT8 data_length, UINT8 *p_data);
#define HCIC_PARAM_PARTIAL_SIZE_SET_CLB_DATA        3
#endif
