...
#undef HCI_STATUS_PARAMS_CMDS_LAST
#define HCI_STATUS_PARAMS_CMDS_LAST     HCI_SET_TRIGGERED_CLOCK_CAPTURE /* B3DS_INCLUDED */
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#define HCI_SYNC_TRAIN_COMP_EVT             0x4F /* B3DS_INCLUDED */
#define HCI_SYNC_TRAIN_RECEIVED_EVT         0x50
#define HCI_CSB_RECEIVED_EVT                0x51
#define HCI_CSB_TIMEOUT_EVT                 0x52
#define HCI_TRUNCATED_PAGE_COMP_EVT         0x53
#define HCI_SLAVE_PAGE_RESPONSE_TIMEOUT_EVT 0x54
#define HCI_CSB_CHANNEL_MAP_CHANGE_EVT      0x55
#define HCI_INQUIRY_RESPONSE_NOTIFY_EVT     0x56
#if defined(MTK_LEGACY_B3DS_SUPPORT) && (MTK_LEGACY_B3DS_SUPPORT == TRUE)
#define HCI_3D_REF_PROTO_ASSOC_NOTIFY       0xFA    /* MTK_Legacy_3DD_EIR_handshake_event */
#endif
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#undef HCI_PAGE_2_EVENT_MASK
#define HCI_PAGE_2_EVENT_MASK                  "\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF"
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#define HCI_EIR_3D_INFORMATION_TYPE          BT_EIR_3D_INFORMATION_TYPE /* B3DS_INCLUDED */
#endif
