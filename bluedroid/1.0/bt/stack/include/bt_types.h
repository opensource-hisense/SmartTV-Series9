...
#define BT_PSM_B3DS                     0x0021 /* B3DS_INCLUDED */
#endif
...
#define BD_LE_NAME_LEN     31
typedef UINT8 BD_LE_NAME[BD_LE_NAME_LEN + 1];         /* Device name */
typedef UINT8 *BD_LE_NAME_PTR;
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#define BT_EIR_3D_INFORMATION_TYPE              0x3D /* B3DS_INCLUDED */
#endif
...
#if defined(MTK_B3DS_SUPPORT) && (MTK_B3DS_SUPPORT == TRUE)
#define TRACE_LAYER_B3DS            0x00310000 /* B3DS_INCLUDED */
#undef TRACE_LAYER_MAX_NUM
