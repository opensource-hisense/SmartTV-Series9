...
void btm_free (void)
{
    // M:   AOSP does not free queues which newed in btm_init().  This bug is found in BT Enable/Disale 100 autotest.
    ...
    // M:  AOSP call list_new in btm _init but never call list_free.
