...
/* eSCO settings for HCI_Enhanced_Setup_Synchronous_Connection command  */
/* HFP 1.6 */
static tBTM_ENH_ESCO_PARAMS btm_enh_esco_defaults =
    {
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
        /* CVSD use HCI_Setup_Synchronous_Connection command  */
        if(p_setup->voice_contfmt==BTM_VOICE_SETTING_CVSD)
        {
#endif
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
      /* mSBC use HCI_Enhanced_Setup_Synchronous_Connection command  */
      }
      else
      {
            BTM_TRACE_API("enh_esco   txbw 0x%x, rxbw 0x%x, lat 0x%x, retrans 0x%02x, pkt 0x%04x",
                btm_enh_esco_defaults.tx_bw, btm_enh_esco_defaults.rx_bw,
                btm_enh_esco_defaults.max_latency,
                btm_enh_esco_defaults.retrans_effort, btm_enh_esco_defaults.packet_types);

            if (btsnd_enh_hcic_accept_esco_conn (bda,
                                           btm_enh_esco_defaults.tx_bw, btm_enh_esco_defaults.rx_bw, btm_enh_esco_defaults.txCoding,
                                           btm_enh_esco_defaults.rxCoding, btm_enh_esco_defaults.txCodecFrameSize,
                                           btm_enh_esco_defaults.rxCodecFrameSize, btm_enh_esco_defaults.inputBandwith,
                                           btm_enh_esco_defaults.outputBandwith, btm_enh_esco_defaults.inputCoding,
                                           btm_enh_esco_defaults.outputCoding, btm_enh_esco_defaults.inputCodedDataSize,
                                           btm_enh_esco_defaults.outputCodedDataSize, btm_enh_esco_defaults.inputPCMDataFormat,
                                           btm_enh_esco_defaults.outputPCMDataFormat, btm_enh_esco_defaults.inputPCMSamplePayloadMSBPos,
                                           btm_enh_esco_defaults.outputPCMSamplePayloadMSBPos, btm_enh_esco_defaults.inputDataPath,
                                           btm_enh_esco_defaults.outputDataPath, btm_enh_esco_defaults.inputTransportUnitSize,
                                           btm_enh_esco_defaults.outputTransportUnitSize, btm_enh_esco_defaults.max_latency,
                                           btm_enh_esco_defaults.packet_types, btm_enh_esco_defaults.retrans_effort))
            {
                p_setup->packet_types = temp_pkt_types;
            }
            else
                                            ...
                                            tBTM_ESCO_PARAMS *p_setup)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (!btsnd_enh_hcic_setup_esco_conn (acl_handle,
                                               btm_enh_esco_defaults.tx_bw, btm_enh_esco_defaults.rx_bw, btm_enh_esco_defaults.txCoding,
                                               btm_enh_esco_defaults.rxCoding, btm_enh_esco_defaults.txCodecFrameSize,
                                               btm_enh_esco_defaults.rxCodecFrameSize, btm_enh_esco_defaults.inputBandwith,
                                               btm_enh_esco_defaults.outputBandwith, btm_enh_esco_defaults.inputCoding,
