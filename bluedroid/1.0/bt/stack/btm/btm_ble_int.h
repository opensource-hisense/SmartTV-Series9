...
#define BTM_BLE_GAP_DISC_SCAN_INT      128        /* Interval(scan_int) = 80 ms= 0x0080 * 0.625 ms */
#else
...
extern void btm_gen_non_resolve_paddr_cback(BD_ADDR_PTR static_random, void *p);
#endif
