...
#if defined(MTK_LINUX_SOCKET_PATH) && (MTK_LINUX_SOCKET_PATH == TRUE)
#ifdef A2DP_CTRL_PATH
#undef A2DP_CTRL_PATH
#endif
#ifdef A2DP_DATA_PATH
#undef A2DP_DATA_PATH
#endif
#define A2DP_CTRL_PATH BT_TMP_PATH"/audio.a2dp_ctrl"
#define A2DP_DATA_PATH BT_TMP_PATH"/audio.a2dp_data"
#endif/*MTK_LINUX_SOCKET_PATH*/
