...
enum
{
    ...
    BTA_GATTC_READ_USING_CHAR_UUID,
    BTA_GATTC_READ_LONG,
#endif
...
#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
/* BTA_GATTC_API_READ_UISNG_CHAR_UUID_EVT */ {BTA_GATTC_FAIL,          BTA_GATTC_IDLE_ST},
/* BTA_GATTC_API_READ_LONG_EVT */            {BTA_GATTC_FAIL,          BTA_GATTC_IDLE_ST},
#endif
...
#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
/* BTA_GATTC_API_READ_UISNG_CHAR_UUID_EVT */ {BTA_GATTC_FAIL,           BTA_GATTC_W4_CONN_ST},
/* BTA_GATTC_API_READ_LONG_EVT */        {BTA_GATTC_FAIL,               BTA_GATTC_W4_CONN_ST},
#endif
...
#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
/* BTA_GATTC_API_READ_UISNG_CHAR_UUID_EVT */ {BTA_GATTC_READ_USING_CHAR_UUID, BTA_GATTC_CONN_ST},
/* BTA_GATTC_API_READ_LONG_EVT */        {BTA_GATTC_READ_LONG,          BTA_GATTC_CONN_ST},
#endif
...
#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
/* BTA_GATTC_API_READ_UISNG_CHAR_UUID_EVT */ {BTA_GATTC_Q_CMD,          BTA_GATTC_DISCOVER_ST},
/* BTA_GATTC_API_READ_LONG_EVT */        {BTA_GATTC_Q_CMD,              BTA_GATTC_DISCOVER_ST},
#endif
...
BOOLEAN bta_gattc_hdl_event(BT_HDR *p_msg)
{
    ...
    switch (p_msg->event)
    {
        ...
        case BTA_GATTC_API_SET_LE_NAME_EVT:
            bta_gattc_set_local_le_name((tBTA_GATTC_DATA *) p_msg);
            break;
#endif

#if defined(MTK_LINUX_GATTC_DISC_MODE) && (MTK_LINUX_GATTC_DISC_MODE == TRUE)
        case BTA_GATTC_API_SET_DISC_MODE_EVT:
            bta_gattc_set_disc_mode((tBTA_GATTC_DATA *) p_msg);
            break;
#endif

#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
        case BTA_GATTC_API_SET_PTS_FLAG_EVT:
            bta_gattc_set_pts_flag((tBTA_GATTC_DATA *) p_msg);
            break;
#endif
        default:
