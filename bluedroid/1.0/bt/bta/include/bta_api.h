...
/* B3DS_INCLUDED */
#define BTA_3DD_SERVICE_ID      31
#define BTA_3DG_SERVICE_ID      32
#define BTA_3DS_SERVICE_ID      33

#undef BTA_USER_SERVICE_ID
#undef BTA_MAX_SERVICE_ID
#define BTA_USER_SERVICE_ID     34          /* User requested UUID */
#define BTA_MAX_SERVICE_ID      35
#endif
...
#define BTA_BLE_GET_ADV_RPA_EVT           1
typedef UINT8 tBTA_BLE_GET_ADV_RPA_EVT;

typedef void (tBTA_BLE_GET_ADV_RPA_CBACK)(tBTA_BLE_GET_ADV_RPA_EVT event,
                                        UINT8 inst_id, bt_bdaddr_t *rpa, void *p_ref, tBTA_STATUS status);
#endif
...
#if defined(MTK_LINUX_GATTC_RPA) && (MTK_LINUX_GATTC_RPA == TRUE)
extern void BTA_BleGetAdvRPA(UINT8 inst_id, tBTA_BLE_GET_ADV_RPA_CBACK *p_cback);
#endif
