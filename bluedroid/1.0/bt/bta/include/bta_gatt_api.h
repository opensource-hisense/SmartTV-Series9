...
#define BTA_GATTC_GET_ADV_RPA_EVT   35  /* get ADV rpa event */
#endif
...
extern void BTA_GATTC_SetLocalLeName(char *p_name);
#endif

#if defined(MTK_LINUX_GATTC_DISC_MODE) && (MTK_LINUX_GATTC_DISC_MODE == TRUE)
extern void BTA_GATTC_SetDiscMode(UINT32 disc_mode);
#endif

#if defined(MTK_LINUX_GATTC_PTS_TEST) && (MTK_LINUX_GATTC_PTS_TEST == TRUE)
extern void BTA_GATTC_ReadUsingCharacteristicUUID(UINT16 conn_id, UINT16 s_handle,
                                                  UINT16 e_handle, tBT_UUID *p_char_uuid,
                                                  tBTA_GATT_AUTH_REQ auth_req);

extern void BTA_GATTC_ReadLongCharacteristic(UINT16 conn_id, UINT16 handle,
                                                  UINT16 offset, tBTA_GATT_AUTH_REQ auth_req);

extern void BTA_GATTC_ReadLongCharDescr(UINT16 conn_id, UINT16 handle,
                                                  UINT16 offset, tBTA_GATT_AUTH_REQ auth_req);

extern void BTA_GATTC_WriteLongCharValue ( UINT16 conn_id,
                                UINT16 handle,
...
extern void BTA_GATTC_WriteLongCharDescrValue ( UINT16 conn_id,
                                                        UINT16 handle,
                                                        tBTA_GATTC_WRITE_TYPE  write_type,
                                                        UINT16 len,
                                                        UINT16 offset,
...
extern void BTA_GATTC_SetPtsFlag(UINT8 pts_flag);
#endif
