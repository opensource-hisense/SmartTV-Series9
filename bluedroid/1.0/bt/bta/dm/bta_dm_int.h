...
enum
{
    ...
    BTA_DM_API_BLE_GET_ADV_RPA_EVT,
#endif
#endif
...
typedef struct
{
    BT_HDR                  hdr;
    UINT8                   inst_id;
    tBTA_BLE_GET_ADV_RPA_CBACK    *p_cback;
}tBTA_DM_API_BLE_GET_ADV_RPA;
...
#if defined(MTK_LINUX_GATTC_RPA) && (MTK_LINUX_GATTC_RPA == TRUE)
    tBTA_DM_API_BLE_GET_ADV_RPA         ble_get_adv_rpa;
#endif
...
typedef struct
{
    ...
    tBTA_BLE_ENERGY_INFO_CBACK   *p_energy_info_cback;
#if defined(MTK_LINUX_GATTC_RPA) && (MTK_LINUX_GATTC_RPA == TRUE)
    tBTA_BLE_GET_ADV_RPA_CBACK   *p_get_adv_rpa_cback;
#endif
#endif
    UINT16                      state;
    BOOLEAN                     disabling;
...
#if defined(MTK_LINUX_GATTC_RPA) && (MTK_LINUX_GATTC_RPA == TRUE)
extern void btm_dm_ble_get_adv_rpa(tBTA_DM_MSG *p_data);
#endif
