...
/*******************************************************************************
**
** Function         bta_sys_custom_eir_register
**
** Description      Called by BTA DM to register EIR utility function that can be
**                  used by the other BTA modules to add/remove custom UUID.
**
** Returns          void
**
*******************************************************************************/
void bta_sys_custom_eir_register(tBTA_SYS_CUSTOM_EIR_CBACK * p_cback)
{
    bta_sys_cb.custom_eir_cb = p_cback;
}
/*******************************************************************************
**
** Function         bta_sys_custom_add_uuid
**
** Description      Called by BTA subsystems to indicate to DM that new custom
**                  service class UUID is added.
**
** Returns          void
**
*******************************************************************************/
void bta_sys_custom_add_uuid(UINT8 * uuid, UINT16 len)
{
    if(bta_sys_cb.custom_eir_cb)
    {
        bta_sys_cb.custom_eir_cb(uuid, len, TRUE);
    }
}
/*******************************************************************************
**
** Function         bta_sys_custom_remove_uuid
**
** Description      Called by BTA subsystems to indicate to DM that new custom
**                  service class UUID is removed.
**
** Returns          void
**
*******************************************************************************/
void bta_sys_custom_remove_uuid(UINT8 * uuid, UINT16 len)
{
    if(bta_sys_cb.custom_eir_cb)
    {
        bta_sys_cb.custom_eir_cb(uuid, len ,FALSE);
    }
}
