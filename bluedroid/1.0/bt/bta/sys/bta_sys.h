...
#define BTA_ID_B3DS         34           /* Bluetooth 3D Syncronizeation Profile */ /* B3DS_INCLUDED */
...
typedef BOOLEAN (tBTA_SYS_CUSTOM_EIR_CBACK)(UINT8* uuid, UINT16 len, BOOLEAN adding);
#endif
#endif
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
extern void bta_sys_custom_eir_register(tBTA_SYS_CUSTOM_EIR_CBACK *p_cback);
extern void bta_sys_custom_add_uuid(UINT8* uuid, UINT16 len);
extern void bta_sys_custom_remove_uuid(UINT8* uuid, UINT16 len);
#endif
#else
